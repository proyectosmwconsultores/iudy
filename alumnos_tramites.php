...
include("head.php");
if ($_SESSION['IdUsua']) {
	$addIngresos = $t->add_ingresos($_SESSION['IdUsua'], 'Está visualizando el reporte de alumnos por tramites administrativos');
}
...
<body class="hold-transition skin-<?php echo $configuracion[15]["Descripcion"]; ?> sidebar-mini fixed">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					Reporte de alumnos con pagos de trámites administrativos
				</h1>
				<ol class="breadcrumb">
								...
								<div class="col-md-5">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<select class="form-control select2" name="txt_grado" id="txt_grado">
												<option value=""> - Seleccione - </option>
	...
	<script>
		function cargar_lista_bajas() {
			...
			if (!IdGrado) {
				swal("Error al buscar", "No seleccionado el Nivel.", "error");
				return 0;
			}
			...
			$(Capa).load("dashboard/lst_alumnos_tramites.php", {
				IdCampus: IdCampus,
				IdGrado: IdGrado
