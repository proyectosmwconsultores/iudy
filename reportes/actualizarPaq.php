<?php
  ...
  $sql9 = $db->query("SELECT tblp_compra.IdPaquete FROM tblp_compra WHERE tblp_compra.IdCompra = '$IdCompra' ");
  $db->rows($sql9);
  ...
  <form name="frm2TYj" id="frm2TYj" action="addActividad.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="box-body">
              ...
              <div class="modal-footer">
                ...
                <button onclick="updPaquete(<?php echo $IdCompra; ?>)" type="button" class="btn btn-primary">Actualizar compra de Paquete</button>
              </div>


  </form>
<script>
    function updPaquete(IdCompra){
      var TipoGuardar = "updPaquete";
      var IdPaquete = document.getElementById("txtPaq").value;

          swal({
            title: "\u00BFEst\u00E1 seguro que desea actualizar el paquete de compra?",
            type: "warning",
          ...
          function (isConfirm) {
            if (isConfirm) {
              ...
              $.ajax({
                   ...
                   method:"POST",
                   data:{TipoGuardar:TipoGuardar, IdCompra:IdCompra, IdPaquete:IdPaquete},
              ...
              .done(function(data) {
                if(data==1){
                  ...
                  parent.location.href='comprar.php?idCompra=1618507368'+IdCompra;
                } else{
