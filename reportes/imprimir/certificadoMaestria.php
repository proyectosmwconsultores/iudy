...
if ($_SESSION['Permisos']) {
	...
	$oferta = $formx->get_oferta_id($cal[0]['IdOferta']);
...
?>
	...
	<body>
	    <?php $tamao = 70; for($m = 0; $m<2; $m++){
	    if($m == 1){ $tamao = 50; }
	    ?>
		<table style='width: 720px; margin-top: <?php echo $tamao; ?>px;'>
			<tr>
		...
		<table style='width: 720px; margin-top: 10px; font-weight: bold; font-family: Arial; font-size: 13px; text-align: justify; '>
			<tr>
				...
				<td style="border-bottom: 0.5px solid black; text-align: center;">
					<?php if($rvoe[0]['Curp']) { echo $rvoe[0]['Curp']; } else { echo $info[0]['P_curp']; } ?>
				</td>
			</tr>
		</table>
		<table style='width: 720px; margin-top: 5px; font-weight: bold; font-family: Arial; font-size: 13px; text-align: justify; '>
			<tr>
				<td style="width: 160px;">
					CURSÓ Y ACREDITÓ
					<?php if($oferta[0]['IdGrado'] == 1){ echo "EL";  } else { echo "LA";} ?>
				</td>
				<td style="border-bottom: 0.5px solid black; text-align: center;">
			...
			<div class="div2">
				...
				<table style="width: 590px; text-align: center; font-weight: bold; font-family: Arial; font-size: 11px; line-height: 15px;">
					<tr>
						...
						<?php echo substr($cert[0]['Cer_final'], 0, 4); ?> &nbsp; </b>
						 </td>
			...
			<tr>
				<td>
					<b>EL PRESENTE DOCUMENTO AMPARA <b class="underlined"> &nbsp; <?php echo $materias[0]['Total']; ?> &nbsp; </b> ASIGNATURAS, QUE
						...
						CRÉDITOS. LA ESCALA DE CALIFICACIONES ES DE 5 A 10 Y LA MÍNIMA APROBATORIA ES DE <b class="underlined"> &nbsp; 8.0 &nbsp; </b>. </b>
						<br>
		...
		<table style=" margin-left: 50px; border-collapse: collapse; margin-top: 10px; width: 640px; text-align: center; font-family: Arial; font-size: 12px; line-height: 15px;">
			<tr>
				<td>
		...
		<table style=" margin-left: 50px; border-collapse: collapse; margin-top: 20px; width: 640px; text-align: center; font-family: Calibri; font-size: 12px; line-height: 15px;">
			<tr>
				<td style="width: 30px;"></td>
				<td style="width: 180px;"></td>
				<td style="width: 40px;"></td>
				<td style="width: 180px; font-family: Arial; "><b>SE AUTENTICA CON FUNDAMENTO EN EL<br> ARTÍCULO 14 DE LA LEY GENERAL DE<br> EDUCACIÓN SUPERIOR</b><br><br><br><br></td>
				<td style="width: 30px;"></td>
			</tr>
			<tr>
				<td style="width: 30px;"></td>
		...
		<table style="margin-left: 0px; border-collapse: collapse; margin-top: 10px; width: 720px; text-align: center; font-family: Calibri; font-size: 12px; line-height: 15px;">
			<tr>
				<td style="width: 200px; text-align: center; font-family: Arial; font-size: 9px; color: #7f7f7f;">
				    <b>
				    <?php if($m == 1){ ?>ESTE CERTIFICADO NO ES VÁLIDO SI PRESENTA BORRADURAS O ENMENDADURAS <br> C O P I A  <?php } else { ?>
				    ESTE CERTIFICADO NO ES VÁLIDO SI PRESENTA BORRADURAS O ENMENDADURAS <br> 
				     </b>
				    <?php }  ?> </td>
			</tr>
		</table>

<?php if($m == 0){ echo "<div class='page-break'></div><br>"; } ?>
