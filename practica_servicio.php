...
include("head.php");
if ($_SESSION['IdUsua']) {
	$addIngresos = $t->add_ingresos($_SESSION['IdUsua'], 'Está en el módulo de alumnos peractia y servicio.');
}
...
<body class="hold-transition skin-<?php echo $configuracion[15]["Descripcion"]; ?> sidebar-mini fixed">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					<i class="fa fa-fw fa-file-text-o"></i> Reporte de alumnos
				</h1>
				<ol class="breadcrumb">
								...
								<div class="col-md-5">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<select class="form-control select2" name="txt_tipo" id="txt_tipo">
												<option value=""> - Seleccione - </option>
													<option value="PP">PRACTICA PROFESIONAL</option>
	...
	<script>
		...
		function lista_alumnos_activos() {
			...
			if (!Tipo) {
				swal("Error al buscar", "Debe seleccionar el tipo de reporte.", "error");
				return 0;
			}
			if (!IdOferta) {
			...
			$(Capa).load("reportes/rep_alumnos_servicio.php", {
				Tipo: Tipo,
				IdOferta: IdOferta
