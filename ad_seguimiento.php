<?php $valor = 3; $section = "Seguimiento de alumnos"; include("head.php");
if($_SESSION['IdUsua']){ $addIngresos=$t->add_ingresos($_SESSION['IdUsua'],'Está en el módulo de seguimiento de alumnos.'); }
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					<i class="fa fa-fw fa-bell"></i> Seguimiento de alumnos
				</h1>
				<ol class="breadcrumb">
          ...
          <div class="box-body">
					<div class="row">
						<form name="frm" id="frm" action="ad_seguimiento.php" method="POST" enctype="multipart/form-data">
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<span class="input-group-btn" >
											<button type="button" onclick="cargar_lista_mat()" class="btn btn-success btn-flat"><i class="fa fa-fw fa-search"></i> Consultar</button>
										</span>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12">
								...
								<div class="box" id="seguimiento_alumnos"></div>
							</div>
...
<script>
	...
	function cargar_lista_mat(){
		...
		document.getElementById("seguimiento_alumnos").style.display = 'none';
		document.getElementById("btn_img").style.display = "block";

		document.getElementById("seguimiento_alumnos").style.display = 'block';
		var Capa = "#seguimiento_alumnos";
		$(Capa).load("dashboard/seguimiento_alumnos_all.php",{IdCampus:IdCampus, IdGrupo:IdGrupo }, function(response, status, xhr) {
