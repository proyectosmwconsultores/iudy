<?php $valor = 3; $section = "Pagos por grupo"; include("head.php");
if($_SESSION['IdUsua']){ $addIngresos=$t->add_ingresos($_SESSION['IdUsua'],'Está en el módulo de generar pagos a grupo.'); }
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					<i class="fa fa-fw fa-file-text-o"></i> Generar pagos al grupo
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-user"></i> Pagos</a></li>
		...
		<div id="dataModalModFue"  class="modal fade">
					<div class="modal-dialog">
							 <div class="modal-content">
										<div class="modal-header" style="background: <?php echo $configuracion[34]['Descripcion']; ?>; color: <?php echo $configuracion[35]['Descripcion']; ?>; font-size: 16px;">
												 ...
												 <h4 class="modal-title"><i class="fa fa-fw fa-cog"></i> Generar pago al grupo</h4>
										</div>
		 ...
		 <div id="dataModalPx"  class="modal fade">
 					<div class="modal-dialog">
 							 <div class="modal-content">
 										<div class="modal-header" style="background: <?php echo $configuracion[34]['Descripcion']; ?>; color: <?php echo $configuracion[35]['Descripcion']; ?>; font-size: 16px;">
 												 <button type="button" class="close" data-dismiss="modal">&times;</button>
 										...
 										<div class="modal-body" id="employee_detailPx">
 										</div>
 							 </div>
 					</div>
 		 </div>
...
<script>
	...
	function load_user_beca(){
		...
		$(Capa).load("dashboard/pagos_alumnos.php",{IdCiclo:IdCiclo, IdGrupo:IdGrupo }, function(response, status, xhr) {
	...
	function configurar_pagos_id(IdModulo, IdCiclo, IdGrupo){
		var IdPlan = 0;
	  $.ajax({
	...
	function configurar_otros_pagos(IdCiclo, IdGrupo){
		var IdPlan = 0;
		$.ajax({
