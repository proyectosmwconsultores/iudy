<?php
  ...
  $sql1 = $db->query("SELECT tblc_campus.IdCampus, tblc_campus.Campus FROM tblc_campus WHERE tblc_campus.id_usua = '$IdUsua'");
  ...
  <form name="frm2xfYj" id="frm2xfYj" action="addNewPago.php" method="POST" enctype="multipart/form-data">
    ...
    <table class="table table-bordered">
      <div class="box box-primary" style="border-top: none; margin-top: -5px;">
        ...
        <div class="col-md-12">
          <div class="row">
            <?php $_x = 0; while($x2 = $db->recorrer($sql2)){
              $IdG = $x2["IdGrupo"];
            ...
            <div class="col-sm-4 col-md-4">
              <div class="color-palette-set" style="padding: 10px; ">
                <?php if($IdAvss){ ?>
                  <button type="button" onclick="actGrupo(<?php echo $IdG; ?>,<?php echo $IdAviso; ?>,0)" class="btn btn-info"><i class="fa fa-check-circle"></i></button>
                <?php } else { $_x = 1; ?>
