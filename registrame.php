...
<html lang="en">
  <head>
    ...
    <title>Registro | MWComenius</title>
  ...
  <div class="register-box">
    <div class="">
       <a onClick="window.open('./','_self')" href="javascript:void(0);" class="text-center db m-b-40"><img src="assets/images/campus/logo_inicio.png" style="width: 20%"></a>
        ...
        <h3 class="fs-subtitle">Para crear tu cuenta necesitas un código generado por tu docente.</h3>
        <span class="help-block">Use un código de clase con 9 letras o números y sin espacios ni símbolos.</span>
        <input type="text" name="txtCode" onchange="valCodex()" id="txtCode" maxlength="9"  placeholder="Código" />
        <input type="text" name="txtEmail" onchange="valEmail()" id="txtEmail" placeholder="Email" />
        <!-- <div id='div_btn1'>

          <input onclick="mostrax()" type="button" value="Validar" />
        </div> -->
...
<script src="dist/login/register-init.js"></script>
