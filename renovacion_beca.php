<?php $valor = 3; $section = "Renovación de beca"; include("head.php");
if($_SESSION['IdUsua']){ $addIngresos=$t->add_ingresos($_SESSION['IdUsua'],'Está en el módulo de renovación de beca.'); }
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					<i class="fa fa-fw fa-file-text-o"></i> Renovación de beca
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-user"></i> Becas</a></li>
					<li class="active">Renovación</li>
				</ol>
			</section>
          ...
          <div class="box-body">
					<div class="row">
						<form name="frm" id="frm" action="renovacion_beca.php" method="POST" enctype="multipart/form-data">
							<div class="col-md-6">
...
<script>
	...
	function load_user_beca(){
		...
		$(Capa).load("dashboard/renovacion_beca_grupo.php",{IdCiclo:IdCiclo, IdGrupo:IdGrupo }, function(response, status, xhr) {
