...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Mi Libros de Consulta UDS</h1>
      <ol class="breadcrumb">
        <li><a href="inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">Libros de Consulta UDS</li>
      </ol>
    </section>
    <section class="content">
      <form name="frm" id="frm" action="libro.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
          <div class="box box-widget widget-user-2">
            <div class="widget-user-header" style=" background: #04152b; color: white;">
              ...
              <h3 class="widget-user-username"><?php echo $oferta[0]["Nombre"]; ?></h3>
              <h5 class="widget-user-desc">Libro de Consulta UDS <?php $num = $oferta[0]["Numero"]; ?></h5>
            </div>
     ...
     <div class="modal-dialog">
          <div class="modal-content">
               <div class="modal-header" style="background: #04152b; color: white; font-size: 16px;">
                    ...
                    <h4 class="modal-title">Libro de Consulta UDS</h4>
               </div>
...
function mostrarCuadro(Grado,Modalidad){
    ...
    $(Capa).load("formConsulta/mostrarLibro.php",{IdOferta:IdOferta,Grado:Grado,Modalidad:Modalidad}, function(response, status, xhr) {
