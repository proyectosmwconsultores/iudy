...
?>
   ...
   <title>Imprimir planeación de clase</title>
  <form name="frm" id="frm" action="addGrupo.php" method="POST" enctype="multipart/form-data">
  	...
  	<div style="margin-left: 1px; margin-top: 15px; ">
  			<table>
  				...
  				<tr>
  					<td style="border: none; width: 590px; text-align: center;"><b>PLANEACIÓN DE CLASE</b></td>
  				</tr>
  		</table>
  		<br>
  		<div style='width: 100%;'>
      ...
      <table>
            ...
            $sql_sem = $db->query("SELECT tblp_semanadocente.IdSemanaDocente, tblp_semanadocente.Etiqueta_semana, tblp_semanadocente.NoSemana, tblp_semanadocente.Temas FROM tblp_semanadocente WHERE tblp_semanadocente.IdParcialDocente =  '$IdParcial' ORDER BY tblp_semanadocente.NoSemana ASC ");
    				?>
            <tr>
      				<td colspan='3' style="width: 650px; padding: 15px; text-align: center; background: #797272;">
      					<b><?php echo $par['Titulo']; ?></b>
      				</td>
      			</tr>
    			<tr>
    				<td rowspan='2' style="width: 142px; "><b><?php echo $par['Titulo']; ?></b></td>
    				<td colspan='2' style="width: 510px; "><b>Tema:</b> <?php echo $par['Tema']; ?></td>
    			</tr>
    			<tr>
    				<td colspan='2' style="width: 510px; "><b>Objetivo:</b> <?php echo $par['Objetivo']; ?></td>
    			</tr>
        ...
        tblp_actividadesdocente.IdSemanaDocente =  '$IdSemana'
         ");
    			...
    			<tr>
    				...
    				<td colspan='2' style="width: 510px"><?php echo $sem['Temas']; ?></td>
    			</tr>
            ...
            <td style="width: 510px">
              <?php echo $act['NomActividad']; ?><br>
              <?php echo $act['Porcentaje']; ?> % <br>
    					<?php echo $act['FecIni'].' al '.$act['FecFin']; ?><br>
            </td>
    			</tr>
