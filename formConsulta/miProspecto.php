<?php
  ...
  $Tipo = $_POST['Tipo'];
  $anio = date("Y");
  $sql_user = $db->query("SELECT tblc_usuario.Nombre, tblc_usuario.APaterno, tblc_usuario.AMaterno, tblc_usuario.IdOferta, tblc_usuario.IdCampus, tblc_usuario.Grado, tblc_usuario.GPago, tblc_usuario.id_ciclo_ini, tblc_usuario.IdOferta, tblc_usuario.IdGrupo, tblc_usuario.id_paquete FROM tblc_usuario WHERE tblc_usuario.IdUsua = '$IdUsua'");
  $db->rows($sql_user);
  ...
  if($idpaq == 'LMS'){ $idpaq = 9; } else { $idpaq = 0;}
  if($g_pago == 1){
...
WHERE
tblc_docalumnos.IdUsua =  '$IdUsua' AND tblc_docalumnos.IdCiclo = '$Id_Ciclo' AND
      ...
      <div class="box box-primary" style="border-top: none; margin-top: -5px;">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <?php if(!isset($_user['id_ciclo_ini'])){ $_valx = 2; ?>
        ...
        <?php if(($g_pago == 0) && (isset($Id_Ciclo))){ $_valx = 2; ?>
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            <table class="table table-striped" style="font-size: 12px;">
              ...
              $IdPlan1 = 0; $IdPlan2 = 0; $Fec1 = ''; $Fec2 = '';
              while($_pag = $db->recorrer($sql_pag)){ $_np = ($_np + 1);
      ...
      <div class="col-md-12" style="font-size: 12px;">
        <div class="form-group">
          ...
          <table class="table table-striped">
            ...
            <?php $recargo = 0;
            while($_gen = $db->recorrer($sql_pag_gen)){ $val_es = $_gen['Estatus'];
              $_valx = 1;
              $IdPag = $_gen['IdPago'];
            ...
            <div class="input-group">
              ...
              <select class="form-control select2" name="_txtGrupo" id="_txtGrupo" style="width: 100%;">
                ...
                <?php while($_grupo = $db->recorrer($sql_grupo)){ ?>
                 ...
                 <?php if(($_grado == 4) && (($tipoGrado == 'CAMBIO DE PLANTEL') || ($tipoGrado == 'CONVALIDACION'))){ $grado = $_grupo['Grado'].'° '; } else { $grado = ''; } ?>
    ...
    function (isConfirm) {
      if(isConfirm) {
        ...
        $.ajax({
             ...
             method:"POST",
             data:{TipoGuardar:TipoGuardar, IdProspecto:IdProspecto, IdCiclo:IdCiclo, IdAdmin:IdAdmin},
        ...
        .done(function(data) {
          if(data==1){
            ...
            $.ajax({
        				 ...
        				 method:"POST",
        				 data:{IdUsua:IdProspecto, Tipo:Tipo},
        				 success:function(data){
    ...
    function (isConfirm) {
      if(isConfirm) {
        ...
        $.ajax({
             url:"formConsulta/setting.php",
             method:"POST",
             data:{TipoGuardar:TipoGuardar, IdProspecto:IdProspecto, IdCiclo:IdCiclo, IdOferta:IdOferta, IdCampus:IdCampus, IdPaq:IdPaq},
             success:function(data){
    ...
    function (isConfirm) {
      if(isConfirm) {
        ...
        $.ajax({
             url:"formConsulta/setting.php",
             method:"POST",
             data:{TipoGuardar:TipoGuardar, IdProspecto:IdProspecto, IdGrupo:IdGrupo, Tipo:Tipo},
             success:function(data){
                alert(data);
             }
        })
