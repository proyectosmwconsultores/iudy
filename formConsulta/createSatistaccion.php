        ...
        <div class="col-md-12">
          <table class="table table-striped">
                ...
                <tr id="B<?php echo $x["IdEncuesta"]; ?>">
                  <td><a class="btn btn-app" onClick="add_encuesta(10,<?php echo $x["IdEncuesta"]; ?>)">&#128512; <br> Muy Satisfecho </a></td>
                  <td><a class="btn btn-app" onClick="add_encuesta(8,<?php echo $x["IdEncuesta"]; ?>)"> &#128521; <br> Satisfecho </a></td>
                  <td><a class="btn btn-app" onClick="add_encuesta(7,<?php echo $x["IdEncuesta"]; ?>)">&#128528; <br> Poco Satisfecho </a></td>
                  <td><a class="btn btn-app" onClick="add_encuesta(5,<?php echo $x["IdEncuesta"]; ?>)">&#128533; <br> Insatisfecho</a></td>
                </tr>
