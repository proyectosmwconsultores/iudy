  ...
  function showUserBuscar(str) {
    var IdCampus = document.getElementById("IdCampus").value;
      if (str == "") {
          ...
          xmlhttp.open("GET","getuser.php?Tipo=planeacion&Buscar="+str+"&IdCampus="+IdCampus,true);
          xmlhttp.send();
      }
  }

  </script>
  <form name="frm2" id="frm2" action="buscarPlaneacion.php" method="POST" enctype="multipart/form-data">
    <input id="IdUsua" name="IdUsua" value="<?php echo $_SESSION["IdUsua"]; ?>" type="hidden"/>
<input id="IdCampus" name="IdCampus" value="" type="hidden"/>
  <div class="table-responsive">
    <table class="table table-bordered">
      <div class="box box-primary" style="border-top: none;">
        ...
        <div class="col-md-12">
          <div class="form-group">
            <label><br>La búqueda puede ser planeaci&oacute;n:</label>
            <div class="input-group">
              <div class="input-group-addon">
                <i class="fa fa-user"></i>
              </div>
              <input class="form-control" id="txtBuscar" name="txtBuscar" placeholder="Escriba los datos del asesor" type="text" onKeyUp="showUserBuscar(this.value)">
            </div>
