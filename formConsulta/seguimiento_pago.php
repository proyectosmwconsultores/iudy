<?php
  ...
  <button type="button" onclick="save_comprobante_id(<?php echo $_POST['IdPago']; ?>,<?php echo $_SESSION['IdUsua']; ?>,<?php echo $_POST['TipoPago']; ?>)" class="btn btn-primary pull-right"><i class="fa fa-fw fa-save"></i> Guardar</button>
  </div>
  </form>
