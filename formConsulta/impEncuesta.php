            ...
            <table class="table table-striped">
                  <tbody>
                    <tr style="background: gray; padding: 15px; text-align: center; font-size: 15px; ">
                      <td colspan="6" style="padding: 5px;">
                          <b>RESULTADO DE LA ENCUESTA DE CALIDAD</b>
                      </td>
                    </tr>
                    <?php

                    $sql = $db->query("SELECT tblx_pregunta.IdPregunta, tblx_pregunta.Pregunta FROM tblx_pregunta WHERE tblx_pregunta.Tipo =  '2' AND tblx_pregunta.IdPregunta < 18"); ?>
                    ...
                    <?php while($x = $db->recorrer($sql)){  $sum6 = 0; $sum7 = 0; $sum8 = 0; $sum9 = 0; $sum10 = 0;
                  ...
                  <tr>
                    <?php $pts = 0; $sumP = 0; while($x2 = $db->recorrer($sql2)){
                      ...
                      ?>
                      <td><?php if($preg==16){ echo "<b>Pasión por Educar</b>"; } else { echo "Excelente"; } ?><br><?php echo $sum10; ?> (<?php echo $x1 = ($sum10 * $res10); ?> pts.)</td>
                      <td><?php if($preg==16){ echo "<b>Responsabilidad</b>"; } else { echo "Bueno"; } ?><br><?php echo $sum9; ?> (<?php echo $x2 = ($sum9 * $res9); ?> pts.)</td>
                      <td><?php if($preg==16){ echo "<b>Calidad</b>"; } else { echo "Regular"; } ?><br><?php echo $sum8; ?> (<?php echo $x3 = ($sum8 * $res8); ?> pts.)</td>
                      <td><?php if($preg==16){ echo "<b>Educación</b>"; } else { echo "Malo"; } ?><br><?php echo $sum7; ?> (<?php echo $x4 = ($sum7 * $res7); ?> pts.)</td>
                      <td><?php if($preg==16){ echo "<b>Otro</b>"; } else { echo "Muy malo"; } ?><br><?php echo $sum6; ?> (<?php echo $x5 = ($sum6 * $res6); ?> pts.)</td>
