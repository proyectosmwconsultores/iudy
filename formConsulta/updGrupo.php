...
if(isset($_POST["employee_id"])){
  ...
  // $sql_user = $db->query("SELECT tblc_usuario.IdUsua, tblc_usuario.Nombre, tblc_usuario.APaterno, tblc_usuario.AMaterno, tblc_usuario.Usuario, tblc_estatus.Estatus, tblc_campus.Campus FROM tblc_usuario Left Join tblc_estatus ON tblc_estatus.IdEstatus = tblc_usuario.IdEstatus Left Join tblc_campus ON tblc_campus.IdCampus = tblc_usuario.IdCampus WHERE tblc_usuario.IdGrupo =  '$IdGrupo' ORDER BY tblc_usuario.Nombre ASC ");
