<?php
  ...
  $sql_ofertas = $db->query("SELECT tblp_modulo.IdEducativa, tblp_educativa.Nombre FROM tblp_modulo Left Join tblp_educativa ON tblp_educativa.IdEducativa = tblp_modulo.IdEducativa WHERE tblp_educativa.IdGrado = '7' AND tblp_modulo.IdCampus =  '$IdCampus' GROUP BY tblp_modulo.IdEducativa ORDER BY tblp_educativa.IdGrado ASC ");
  ...
  <form name="frm2xfYj" id="frm2xfYj" action="addNewPago.php" method="POST" enctype="multipart/form-data">
    ...
    <input id="txtCampusId" name="txtCampusId" value="6" type="hidden"/>
    ...
    <table class="table table-bordered">
      <div class="box box-primary" style="border-top: none; margin-top: -5px;">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <select class="form-control" name="txtIdOfertaid" id="txtIdOfertaid" onchange="cambioPlanEstudios2(<?php echo $IdOferta; ?>)">
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <select class="form-control" name="txtCicloId" id="txtCicloId" onchange="cambioCiclo2(<?php echo $IdOferta; ?>)">
                <option value=""> - Seleccione - </option>
        ...
        <div class="col-md-12" style="font-size: 13px;">
          <div class="form-group">
          <div class="bg-navy-active color-palette" style='padding: 5px;'><span><b>Nota:</b> al realizar el cambio de grupo deberá de cargar las nuevas materias que llevará.</span></div>
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group">
        ...
        <div class="col-md-12">
          <div class="form-group">
              <button type="button" class="btn btn-block btn-info" onclick="cambiarPlantel_ok2(<?php echo $_SESSION['IdUsua']; ?>,<?php echo $IdOferta; ?>)"> <i class="fa fa-save"></i> Cambiar grupo</button>
          </div>
        </div>
...
function cambioPlanEstudios2(IdOferta){
...
function cambioCiclo2(IdOferta){
  var IdCiclo = document.getElementById("txtCicloId").value;
  var IdCampus = document.getElementById("txtCampusId").value;
  var IdOferta = document.getElementById("txtIdOfertaid").value;
  var IdUsua = document.getElementById("IdUsua").value;
...
function cambiarPlantel_ok2(IdAdmin,IdOferta){
    var IdCampus = '6';
    var IdUsua = document.getElementById("IdUsua").value;
    var IdOferta = document.getElementById("txtIdOfertaid").value;
    ...
    var TipoGuardar = "cambiar_plantel_grupo_diplomado";
    swal({
