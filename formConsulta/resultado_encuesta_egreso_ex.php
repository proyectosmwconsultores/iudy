...
header("Content-Disposition: attachment; filename=resultado_encuesta_egreso.xls");
  ...
  <table class="table table-striped" style="font-size: 12px;">
         <tbody>
           <tr style="background: #5a284f; color: #fbeb00; padding: 10px;">
             <td colspan="7">
               <b><?php echo htmlentities($_mt['Nombre']).' - '.$_mt['_Modalidad'].' - '.$_mt['_Dias']; ?> </b>
             </td>
           </tr>
...
<table id="datatable_prom_ex" class="table table-striped" style="font-size: 12px;">
  ...
  <tbody>
    ...
    ?>
    <tr>
      <td style="text-align: right"><b>Promedio alcanzado en esta encuesta:</b></td>
      <td style="text-align: center;"><b><?php echo $promx; ?></b></td>
    </tr>
  </tbody>
</table>
<?php } ?>
