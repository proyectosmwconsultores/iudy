...
include('../hace.php');
  ...
  $IdDocente =  $porciones[1]; // porción2
  $IdModulo =  $porciones[2]; // porción2
  $IdGrupo =  $porciones[3]; // porción2
...
WHERE
tblx_respuesta.IdDocente =  '$IdDocente' AND
tblx_respuesta.IdModulo =  '$IdModulo' AND
tblx_respuesta.IdGrupo =  '$IdGrupo'
GROUP BY
tblx_respuesta.IdDocente
");
   $db->rows($sql9);
   ...
   $sql = $db->query("SELECT tblx_respuesta.IdPregunta, Sum(tblx_respuesta.Respuesta) AS Total, tblx_pregunta.Pregunta FROM tblx_respuesta Left Join tblx_pregunta ON tblx_pregunta.IdPregunta = tblx_respuesta.IdPregunta
   WHERE tblx_respuesta.IdModulo =  '$IdModulo' AND tblx_respuesta.IdDocente = '$IdDocente' AND tblx_respuesta.IdGrupo = '$IdGrupo' GROUP BY tblx_respuesta.IdPregunta"); ?>
    ...
    <div class="table-responsive">
          ...
          <div class="col-md-12">
            ...
            <table class="table table-striped">
                ...
                <?php }  ?>
                <tr>
                  <td colspan="5" style="text-align: right;"><b>promedio del docente:</b></td>
                  <td><b><?php if($prom){ $pmr = ($prom/10);  echo round($pmr,2);} ?></b></td>
                </tr>
                </tbody></table>
              </div>
          </div>
