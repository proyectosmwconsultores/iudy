<?php $valor = 3; $section = "Alumnos extemporaneos"; include("head.php");
if($_SESSION['IdUsua']){ $addIngresos=$t->add_ingresos($_SESSION['IdUsua'],'Está en el módulo de alumnos extemporaneos'); }
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					Configuraci&oacute;n de alumnos extemporaneos
				</h1>
				<ol class="breadcrumb">
      ...
      <form name="frm" id="frm" action="adAlumnosEx.php" method="POST" enctype="multipart/form-data">
