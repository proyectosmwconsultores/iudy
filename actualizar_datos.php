...
if (isset($_POST["Mov"]) && $_POST["Mov"] == "eliminar") {
  $t->del_firma();
  exit;
}
...
$_f = 0;
if ($datosUser[0]['id_paquete']) {
  $paq = $datosUser[0]['id_paquete'];
              ...
              <div class="paytabs-card">
                ...
                <div class="paytabs-content">
                  <div class="paypanel is-active" data-content="pendientes">
                    <form class="form-horizontal" name="frm" id="frm" action="actualizar_datos.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          <label class="col-sm-4 control-label">Firma digital:</label>
                          <div class="col-sm-8">
                            <input id="firma" name="firma" type="file" onchange="validarFirma(this);">
                            <p class="help-block" style="color: red;"><b style="color: blue;">Nota:</b> Recuerde que su firma debe ser una imagen (.PNG, .JPG), con fondo blanco y/o transparente.</p>
                          </div>
                        </div>
                        <div class="form-group">
                    ...
                    <?php if($_f == 1){ ?>
          <div class="box box-primary" style="width: 250px;">
            <div class="box-body box-profile" style="text-align: center;">
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <i class="fa fa-file-image-o"></i> Imagen de la firma
                </li>
              </ul>
              <img src="<?php echo $path; ?>" style="width: 100%;"><br>
              <a onclick="del_firma(<?php echo $_SESSION['IdUsua']; ?>)" class="btn btn-danger btn-block" style="margin-top: 10px; "><i class="fa fa-fw fa-trash"></i> Eliminar mi firma</a>
            </div>
          </div>
        <?php } ?>
...
<!-- AdminLTE App -->
  ...
  <script>
    ...
    function del_firma(IdUsua) {
      swal({
          title: "\u00BFEst\u00E1 seguro que desea eliminar su firma digital?",
          type: "warning",
        ...
        function(isConfirm) {
          if (isConfirm) {
            document.frm.Mov.value = 'eliminar';
            document.frm.submit();
            return true;
          } else {
            return false;
