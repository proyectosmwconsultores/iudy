        ...
        <tr>
          ...
          <td>
            <?php if($sql_user[$i]['Migrado'] == 1){ ?>
              <button onclick="cargar_lista_alumnos(<?php echo $sql_user[$i]['IdGrupo']; ?>, 1)" type="button" class="btn bg-maroon btn-flat btn-sm"><i class="fa fa-fw fa-check-circle"></i> Migrado</button>
            <?php } else { ?>
              <button onclick="cargar_lista_alumnos(<?php echo $sql_user[$i]['IdGrupo']; ?>, 0)" type="button" class="btn bg-navy btn-flat btn-sm"><i class="fa fa-fw fa-warning"></i> Procesar migración</button>
            <?php  } ?>            
          </td>
