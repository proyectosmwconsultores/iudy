...
<div class="box-body box-profile">
  ...
  if ($alumno[0]['Estatus'] <> 'En proceso') {
    ...
    <?php if ((isset($_mod60[0])) && ($alumno[0]['IdEstatus'] == 8) && ($disx == 2)) { ?>
      <a style="text-align: left;" onclick="horario_personalizado_especial(<?php echo $IdUsua; ?>)" href="javascript:void(0);" class="btn btn-warning btn-block"><i class="fa fa-briefcase"></i> Materia personalizado</a>
    <?php } ?>
