...
$_user = $consul->get_alumno_code_id($idToks);
$_vigencia = $consul->get_vigencia_id($_user[0]['IdUsua']);
...
<div class="box-primary">
  <div class="box-body box-profile" style="text-align: center; height: 404px;" id="imagen">
    ...
    <div style="width: 100%; height: 90px; text-align: right; margin-top: -488px; ">
      <p style="font-size: 11px; color: white; height: 90px; writing-mode: vertical-rl; display: inline; transform: rotate(180deg); margin-left: -0px;">IUDY-VH 0000</p>
    ...
    <div style="width: 100%; height: 42px; text-align: right; margin-top: 21px; text-align: center;">
    ...
    <div style="width: 100%; height: 20px; text-align: right; margin-top: 1px; text-align: left;">
      <p style="color: #fff; font-size: 13px; font-family: Arial Nova; margin-left: 140px;">
