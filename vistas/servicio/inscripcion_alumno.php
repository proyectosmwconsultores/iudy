...
<input type="hidden" name="IdMuni_D" id="IdMuni_D" value="<?php echo $user[0]["D_municipio"]; ?>">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <select class="form-control" name="txt_cuatrimestre" id="txt_cuatrimestre">
        ...
        <option value="10" <?php if(isset($lst[0]["Grado"])){ if($lst[0]["Grado"]==10){?>selected="selected"<?php } } ?>> 10 CUATRIMESTRE</option>
      </select>
      </div>
    </div>
  ...
  <div class="box-header with-border">
    <h3 class="box-title"><i class="fa fa-fw fa-bank"></i> Información para el Servicio Social</h3>
  </div>
  
  <div class="box-body">
    <?php if ($lst[0]['IdEstatus'] == 4) { ?>
      <div class="bg-black-active color-palette" style="padding: 8px;"><span><i class="fa fa-fw fa-check-circle"></i> La inscripción al servicio social ha sido aprobada. </span></div>
    <?php } ?><br>
    ...
    <div class="form-group">
      <label class="col-sm-8 control-label">Fecha de inicio de servicio social:</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <label class="col-sm-4 control-label">Ubicación de asignacion:</label>
      <div class="col-sm-8">
        <input class="form-control" type="text" onchange="verificar_texto(this,'txt_ubicacion')" name="txt_ubicacion" id="txt_ubicacion" value="<?php echo $lst[0]['Area_ubicacion']; ?>">
      </div>
    </div>
    <div class="form-group">
      <label class="col-sm-4 control-label">Programa / proyecto:</label>
      <div class="col-sm-8">
    ...
    <div class="form-group">
      <label class="col-sm-4 control-label">Área de atención:</label>
      <div class="col-sm-8">
        <input class="form-control" type="text" onchange="verificar_texto(this,'txt_atencion')" name="txt_atencion" id="txt_atencion" value="<?php echo $lst[0]['Area_atencion']; ?>">
      </div>
    </div>
    ...
    <div class="form-group" style="float: right;">
      <div class="col-sm-12" id="_ocultar">
        <?php if ($_SESSION['Permisos'] == 3) { ?>
          <?php if ($lst[0]['IdEstatus'] == 5) { ?>
            <button type="button" onclick="sav_datos_practica(<?php echo $IdUsua; ?>,<?php echo $IdAviso; ?>,<?php echo $IdDetalle; ?>,<?php echo $lst[0]['IdServicio']; ?>, 5, <?php echo $Tipo; ?>)" class="btn bg-orange btn-flat "><i class="fa fa-refresh"></i> Actualizar datos</button>
            <button type="button" onclick="cancelar_inscripcion(<?php echo $IdUsua; ?>,<?php echo $lst[0]['IdServicio']; ?>)" class="btn bg-primary btn-flat "><i class="fa fa-trash"></i> Cancelar mi solicitud</button>
            <br><br>
            <div class="bg-maroon-active color-palette" style="padding: 5px;"><span><i class="fa fa-fw fa-times-circle"></i> La inscripción para su Servicio Social no fue aprobada. </span></div>
          <?php } ?>

          <?php if ($lst[0]['IdEstatus'] == 1) { ?>
            <button type="button" onclick="sav_datos_practica(<?php echo $IdUsua; ?>,<?php echo $IdAviso; ?>,<?php echo $IdDetalle; ?>,<?php echo $lst[0]['IdServicio']; ?>, 31, <?php echo $Tipo; ?>)" class="btn bg-purple btn-flat margin"><i class="fa fa-save"></i> Guardar datos</button>
          <?php } ?>
          <?php if ($lst[0]['IdEstatus'] == 31) { ?>
            <button type="button" onclick="sav_datos_practica(<?php echo $IdUsua; ?>,<?php echo $IdAviso; ?>,<?php echo $IdDetalle; ?>,<?php echo $lst[0]['IdServicio']; ?>, 31, <?php echo $Tipo; ?>)" class="btn bg-maroon btn-flat margin"><i class="fa fa-refresh"></i> Actualizar datos</button>
            <button type="button" onclick="sav_datos_practica(<?php echo $IdUsua; ?>,<?php echo $IdAviso; ?>,<?php echo $IdDetalle; ?>,<?php echo $lst[0]['IdServicio']; ?>, 3, <?php echo $Tipo; ?>)" class="btn bg-orange btn-flat margin"><i class="fa fa-send-o"></i> Enviar mi solicitud para inscripción</button>
          <?php } ?>
        <?php } ?>
        <?php if (($_SESSION['Permisos'] == 9) || ($_SESSION['Permisos'] == 1)) { ?>
          ...
          <?php } ?>
        <?php } ?>
        <?php if (($_SESSION['Permisos'] == 7) || ($_SESSION['Permisos'] == 6) || ($_SESSION['Permisos'] == 1)) { ?>
          <?php if ($lst[0]['IdEstatus'] == 3) { ?>
          <button type="button" onclick="sav_datos_practica(<?php echo $IdUsua; ?>,<?php echo $IdAviso; ?>,<?php echo $IdDetalle; ?>,<?php echo $lst[0]['IdServicio']; ?>, 1, <?php echo $Tipo; ?>)" class="btn bg-maroon btn-flat margin"><i class="fa fa-refresh"></i> Actualizar datos</button>
            <!-- <button type="button" onclick="sav_datos_practica(<?php echo $IdUsua; ?>,<?php echo $IdAviso; ?>,<?php echo $IdDetalle; ?>,<?php echo $lst[0]['IdServicio']; ?>, 31, <?php echo $Tipo; ?>)" class="btn bg-maroon btn-flat margin"><i class="fa fa-times-circle"></i> Regresar captura al alumno</button> -->
            <button type="button" onclick="sav_no_cumple()" class="btn bg-maroon btn-flat margin"><i class="fa fa-times-circle"></i> El alumno no cumple</button>
            <!-- <button type="button" onclick="sav_datos_practica(<?php echo $IdUsua; ?>,<?php echo $IdAviso; ?>,<?php echo $IdDetalle; ?>,<?php echo $lst[0]['IdEstatus']; ?>, 3, <?php echo $Tipo; ?>)" class="btn bg-orange btn-flat margin"><i class="fa fa-refresh"></i> Actualizar</button> -->
            <button type="button" onclick="sav_datos_practica_gestion(<?php echo $IdUsua; ?>,<?php echo $IdAviso; ?>,<?php echo $IdDetalle; ?>,<?php echo $lst[0]['IdServicio']; ?>, 4, <?php echo $Tipo; ?>)" class="btn bg-purple btn-flat margin"><i class="fa fa-check-circle"></i> Aceptar alumno</button>
          <?php } ?>
        <?php } ?>
        <br>
      </div>
      ...
      <?php if ($_SESSION['Permisos'] == 3) { ?>
        <?php if ($lst[0]['IdEstatus'] == 31) { ?>
          <div class="bg-navy-active color-palette" style="padding: 8px;"><span><i class="fa fa-fw fa-hourglass-start"></i> Su inscripción para su Servicio Social se encuentra en captura. </span></div>
        <?php } ?>
        
        <?php if ($lst[0]['IdEstatus'] == 3) { ?>
          <div class="bg-teal-active color-palette" style="padding: 8px;"><span><i class="fa fa-fw fa-caret-square-o-right"></i> La inscripción al Servicio Social se encuentra en Revisión por Gestión Escolar. </span></div>
        <?php } ?>
        <?php } ?>
        <?php if ($lst[0]['IdEstatus'] == 4) { ?>
          <?php if (($_SESSION['Permisos'] == 6) || ($_SESSION['Permisos'] == 7) || ($_SESSION['Permisos'] == 1)) { ?>
          <button type="button" onclick="sav_datos_practica_acept(<?php echo $IdUsua; ?>,<?php echo $IdAviso; ?>,<?php echo $IdDetalle; ?>,<?php echo $lst[0]['IdServicio']; ?>, 2, <?php echo $Tipo; ?>)" class="btn bg-orange btn-flat margin"><i class="fa fa-refresh"></i> Actualizar</button>
          <?php } ?>
          <button type="button" onclick="javascript:window.open('repositorio/formatos/carta_presentacion_ss.php?idToks=<?php echo time() . $lst[0]['IdServicio']; ?>');" href="javascript:void(0);" title="Imprimir carta de presentación." class="btn bg-maroon btn-flat"><i class="fa fa-print"></i> Carta de Presentación</button>
        <?php } ?>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <button type="button" onclick="sav_motivo_no_cumple(<?php echo $IdUsua; ?>,<?php echo $IdAviso; ?>,<?php echo $IdDetalle; ?>,<?php echo $lst[0]['IdServicio']; ?>, 5, <?php echo $Tipo; ?>)" class="btn bg-maroon btn-flat margin"><i class="fa fa-times-circle"></i> Guardar motivo</button>
    </div>
...
<script>
  ...
  function sav_datos_practica(IdUsua, IdAviso, IdDetalle, IdServicio, IdEstatus, Tipo) {
    ...
    var Ubicacion = document.getElementById("txt_ubicacion").value;
    ...
    if (Fecha == '') {
      swal("Error al guardar", "Debe escribir la Fecha de inicio de servicio social.", "error");
    ...
    // }
    if (Area == '') {
      swal("Error al guardar", "Debe escribir el Área en la que estaras asignado para prestar tu servicio social.", "error");
      document.getElementById("txt_area").focus();
      return 0;
    }
    swal({
        title: "\u00BFEst\u00E1 seguro que desea guardar estos para su servicio social?",
        type: "warning",
      ...
      function(isConfirm) {
        if (isConfirm) {
          ...
          $.ajax({
            ...
            .done(function(data) {
              if (data == 1) {
                swal("Guardado correctamente", "Los datos para la inscripción al servicio social se han guardado correctamente.", "success");
                if (Tipo == 2) {
  ...
  function sav_datos_practica_acept(IdUsua, IdAviso, IdDetalle, IdServicio, IdEstatus, Tipo) {
      ...
      function(isConfirm) {
        if (isConfirm) {
          ...
          $.ajax({
            ...
            .done(function(data) {
              if (data == 1) {
                swal("Actualizado correctamente", "Los datos para la inscripción al servicio social se han actualizado correctamente.", "success");
                load_user_beca(4);
                $.ajax({
                  url: "vistas/servicio/inscripcion_alumno.php",
                  method: "POST",
  ...
  function sav_datos_practica_gestion(IdUsua, IdAviso, IdDetalle, IdServicio, IdEstatus, Tipo) {
    var Direccion = document.getElementById("txt_direccion").value;
    var Estado = document.getElementById("txt_estado").value;
    var Municipio = document.getElementById("txt_municipio").value;
    var CPAlumno = document.getElementById("txt_cp_alumno").value;
      ...
      function(isConfirm) {
        if (isConfirm) {
          ...
          $.ajax({
            ...
            .done(function(data) {
              if (data == 1) {
                swal("Aceptado correctamente", "El alumno se ha aceptado correctamente para su proceso de servicio social.", "success");
                if (Tipo == 2) {
                  load_user_beca(IdEstatus);
                }
                $.ajax({
...
function sav_motivo_no_cumple(IdUsua, IdAviso, IdDetalle, IdServicio, IdEstatus, Tipo) {
    ...
    swal({
        title: "\u00BFEst\u00E1 seguro que desea no aceptar para este servicio social del alumno?",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: '#DD6B55',
        confirmButtonText: 'Aceptar',
      ...
      function(isConfirm) {
        if (isConfirm) {
          ...
          $.ajax({
            ...
            .done(function(data) {
              if (data == 1) {
                swal("Guardado correctamente", "La inscripción al servicio social del alumno se ha cancelado correctamente.", "success");
                load_user_beca(IdEstatus);
                $.ajax({
                  url: "vistas/servicio/inscripcion_alumno.php",
                  method: "POST",
  ...
  function cancelar_inscripcion(IdUsua, IdServicio) {
    
    var TipoGuardar = "sav_cancelar_inscripcion_alumno";
    
    swal({
        title: "\u00BFEst\u00E1 seguro que desea cancelar su inscripción de su servicio social?",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: '#DD6B55',
        confirmButtonText: 'Aceptar',
          ...
          $.ajax({
            ...
            .done(function(data) {
              if (data == 1) {
                ...
                swal("Eliminado correctamente", "Sus datos para la inscripción al servicio social se han eliminado correctamente.", "success");
              } else {
