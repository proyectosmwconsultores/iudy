...
<?php if ($var == 2) { ?>
  ...
  <div class="box">
    ...
    <div class="box-body">
      <p>El alumno, ahora ya tiene disponible para descargar los siguientes documentos:</p>
      <ul class="mailbox-attachments clearfix">
        <li style="width: 240px; cursor: pointer;" onclick="javascript:window.open('repositorio/formatos/carta_presentacion_ss.php?idToks=<?php echo time() . $pract_id[0]['IdServicio']; ?>');" href="javascript:void(0);">
        ...
        <li style="width: 240px; cursor: pointer;" onclick="javascript:window.open('assets/docs/ServicioSocial/CARTA_DE_ASIGNACION_DE_SERVICIO_SOCIAL26.xlsx','_blank');" href="javascript:void(0);">
        ...
        <li style="width: 240px; cursor: pointer;" onclick="javascript:window.open('assets/docs/ServicioSocial/FORMATO_DE_REPORTE_INICIAL_IUDY_2026.doc','_blank');" href="javascript:void(0);">
          <div class="mailbox-attachment-info">
      ...
      <?php if ($pract_id[0]['_validado'] == 2) { ?>
        <ul class="mailbox-attachments clearfix">
          <li style="width: 240px; cursor: pointer;" onclick="javascript:window.open('assets/docs/ServicioSocial/6_FORMATO_DE_REPORTE_BIMESTRAL-IUDY_25.doc','_blank');" href="javascript:void(0);">
            <div class="mailbox-attachment-info">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <select class="form-control" name="txtTipoDoc" id="txtTipoDoc">
              ...
              <option value="119">CARTA DE TERMINACION </option>
            </select>
          </div>
        </div>
        <div class="form-group">
