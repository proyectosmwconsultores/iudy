  ...
  <div class="table-responsive">
    <table class="table table-bordered">
      <div class="box-body">
        ...
        <div class="col-md-12">
          <div class="form-group">
            <label>Texto del aviso del servicio social:</label>
            <div class="input-group">
...
<script>
  function sav_new_aviso(IdUsua) {
    ...
    swal({
        title: "\u00BFEst\u00E1 seguro que desea guardar este aviso para el servicio social?",
        type: "warning",
        ...
        if (isConfirm) {
          ...
          $.ajax({
            ...
            .done(function(data) {
              ...
              if (data == 2) {
                swal("Error al guardar", "No se puede realiza el proceso.", "info");
              }
            })
            .error(function(data) {
