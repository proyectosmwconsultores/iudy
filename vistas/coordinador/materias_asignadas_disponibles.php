  ...
  <div class="box-body">
    ...
    <table id="example" class="table table-striped table-bordered table-hover dataTables-example" style="font-size: 12px;" >
      ...
      <tbody>
        ...
        <tr>
          <td>
            <button type="button" title="Ver lista de alumnos" class="btn bg-yellow btn-flat btn-sm view_users" href="javascript:void(0);" name="view" value="view" id="<?php echo $matx["IdAsignacion"]; ?>" style="float: center;"><i class="fa fa-users"></i></button>
            <button onclick="relacionar_grp('<?php echo $matx["IdAsignacion"]; ?>',<?php echo $matx["IdCiclo"]; ?>)" type="button" title="Duplicar materia" class="btn bg-navy btn-flat btn-sm" href="javascript:void(0);" style="float: center;"><i class="fa fa-cog"></i></button>
          </td>
