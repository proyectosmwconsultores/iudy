...
if($_SESSION['IdUsua']){ $addIngresos=$t->add_ingresos($_SESSION['IdUsua'],'Está en le módulo de generar pagos a grupo'); }
...
if(isset($_POST["Mov"]) && $_POST["Mov"]=="genPagoGrp"){
  $t->add_generarPagosGrp();
  exit;
}
$lstConceptos=$t->get_conceptosPlan($_POST["txtOferta"]);
$lstGrupo=$t->get_lstGrupos($_POST["txtCicloEscolar"],$_POST["txtConcepto"]);
$calen=$t->get_lstCanlendarioGrp($_POST["txtOferta"],$_POST["txtCicloEscolar"],$_POST["txtGrupo"]);
?>
...
<body class="hold-transition skin-<?php echo $configuracion[15]["Descripcion"]; ?> sidebar-mini fixed">
	<form name="frm" id="frm" action="ctrlGenPagGrupo.php" method="POST" enctype="multipart/form-data">
		<input id="TipoGuardar" name="TipoGuardar" value="val_addGenerarPagGrp" type="hidden"/>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					Configuración de pagos a grupo
				</h1>
				<ol class="breadcrumb">
				...
				<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<div class="input-group">
									<button id="bntGenerarP" name="bntGenerarP" type="button" class="btn btn-danger" onClick="val_addGenerarPagGrp()"><i class="fa fa-dollar"></i> Generar pago a grupo</button>
								</div>
							</div>
						</div>
						<div class="col-xs-12">
