<aside class="kx-card kx-sidebar" aria-label="Menú del alumno">
  ...
  <ul class="kx-menu">
    <li><a class="is-<?php if($var == 1){ echo "active"; } ?>" href="espacioUsuario.php" ><span class="ico">🏠</span> Mi espacio</a></li>
    <li><a style="cursor: pointer;" onclick="change_pass_id()"><span class="ico">🔒</span> Cambiar contraseña</a></li>
    <li><a class="is-<?php if($var == 3){ echo "active"; } ?>" href="actualizar_datos.php"><span class="ico">👤</span> Mis datos</a></li>
    <li><a class="is-<?php if($var == 4){ echo "active"; } ?>" href="misDocDocente.php"><span class="ico">📄</span> Mis documentos</a></li>
    <li><a class="is-<?php if($var == 5){ echo "active"; } ?>" href="mi_reconocimiento.php"><span class="ico">💼</span> Mis reconocimientos</a></li>
  </ul>
