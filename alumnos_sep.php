<?php $valor = 3; $section = "Alumnos SEP"; include("head.php");
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					<i class="fa fa-fw fa-file-text-o"></i> Concentrado SEP
				</h1>
				<ol class="breadcrumb">
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<select class="form-control select2" name="txtCampus" id="txtCampus">
											...
											<option value="1">CAMPUS VILLAHERMOSA</option>
											<option value="2">CAMPUS COMALCALCO</option>
											<option value="3">CAMPUS TEAPA</option>
											<option value="4">CAMPUS EMILIANO ZAPATA</option>
										</select>
...
<script>
	...
	function load_user_lista(){
		...
		$(Capa).load("dashboard/lista_alumnos_sep.php",{IdCiclo:IdCiclo, IdCampus:IdCampus }, function(response, status, xhr) {
			if (status == "error") {
