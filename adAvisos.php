...
$lstDocs=$t->get_docsAvisosUs($_SESSION['IdUsua']);
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-default">
        <div class="box-body">
          <div class="row">
					  <form name="frm" id="frm" action="adAvisos.php" method="POST" enctype="multipart/form-data">
					...
					<div class="col-md-4">
						<div class="box-primary">
							...
							<div class="box-footer" style=" text-align: right;">
								<button type="button" class="btn btn-success" onClick="val_loadAvs()"><i class="fa fa-fw fa-save"></i> Subir aviso </button>
							</div>
							</div>
						</div>
					</div>
