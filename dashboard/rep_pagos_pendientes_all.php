...
");
  ...
  <?php if($s_cic){ ?>
    <button onClick="window.open('dashboard/rep_pagos_pendientes_all_ex.php?IdCampus=<?php echo $_POST['IdCampus']; ?>','_self')" href="javascript:void(0);" type="button" class="btn btn-block btn-danger btn-xs"><i class="fa fa-fw fa-cloud-download"></i> Descargar excel</button>
   <button onClick="window.open('formConsulta/impReporte.php?idCa=<?php echo time().$_POST['IdCampus']; ?>&idEs=16546281088','_blank')" href="javascript:void(0);" type="button" class="btn btn-block btn-info btn-xs"><i class="fa fa-fw fa-eye"></i> Ver concentrado</button>
 <?php } ?>
