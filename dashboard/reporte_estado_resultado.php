<?php
  ...
  <?php if($sz){ ?>
   <button onClick="window.open('dashboard/reporte_estado_resultado_ex.php?AnioMes=<?php echo $AnioMes; ?>','_self')" href="javascript:void(0);" type="button" class="btn btn-block btn-danger btn-xs"><i class="fa fa-fw fa-cloud-download"></i> Descargar excel</button>
 <?php } ?>
