...
<table class="table table-striped" style="font-size: 12px;">
      ...
      <button onclick="window.open('dashboard/alumnos_cartera_vencida_excel.php?IdCampus=<?php echo $IdCampus; ?>','_self')" href="javascript:void(0);" type="button" class="btn btn-block btn-danger btn-xs"><i class="fa fa-fw fa-cloud-download"></i> Descargar excel</button>
