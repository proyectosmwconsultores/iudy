<?php $valor = 3;
$section = "Seguimiento prácticas profesionales";
include("head.php");
if ($_SESSION['IdUsua']) {
	$addIngresos = $t->add_ingresos($_SESSION['IdUsua'], 'Está en el módulo de seguimiento de prácticas profesionales.');
}
$practi = $t->get_all_practicas_prof();
$IdEstatus = 3;
...
<body class="hold-transition skin-<?php echo $configuracion[15]["Descripcion"]; ?> sidebar-mini fixed">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					<i class="fa fa-fw fa-file-text-o"></i> Seguimiento de prácticas profesionales
				</h1>
				<ol class="breadcrumb">
							...
							<form name="frm" id="frm" action="docs_alumnos.php" method="POST" enctype="multipart/form-data">
								...
								<div class="col-md-8">
									<div class="form-group">
										<label>Convocatorias de Prácticas profesionales:</label>
	...
	<script>
		...
		function load_user_beca(IdEstatus) {
			...
			if (!IdAviso) {
				swal("Error al buscar", "Debe seleccionar la convocatoria de la práctica profesional.", "error");
				return 0;
			}
			...
			$(Capa).load("vistas/practicas/seguimiento_practicas_profesionales.php", {
				IdAviso: IdAviso,
				IdEstatus:IdEstatus
