  ...
  <div class="register-box">
    <div class="">
       <a onClick="window.open('./','_self')" href="javascript:void(0);" class="text-center db m-b-40"><img src="assets/images/campus/logo_inicio.png" style="width: 20%"></a>
        ...
        <!-- fieldsets -->
        <fieldset id='btn1'>
        <h2 class="fs-title">Crea tu cuenta como docente</h2>
        <h3 class="fs-subtitle">Usted como docente puede crear una cuenta gratis, despues podrá adquirir espacio para sus alumnos.</h3>
        ...
        <select class="form-control" name="txtTipo" id="txtTipo">
          ...
          <option value="1">Bronce / 70 alumnos / $800.00 Año</option>
          <option value="2">Plata / 160 alumno / $1500.00 Año</option>
          <option value="3">Oro / 360 alumnos / $3000.00 Año</option>
          <!-- <option value="4">Diamante / 1000 alumnos $375.00 Mes</option> -->
        </select>
        <!-- <div id='div_btn1'>
