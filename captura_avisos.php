...
include("head.php");
if ($_SESSION['IdUsua']) {
	$addIngresos = $t->add_ingresos($_SESSION['IdUsua'], 'Está en el módulo de captura de avisos.');
}
?>
...
<body class="hold-transition skin-<?php echo $configuracion[15]["Descripcion"]; ?> sidebar-mini fixed">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					<i class="fa fa-fw fa-bell"></i> Avisos
				</h1>
				<ol class="breadcrumb">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header" style="background: <?php echo $configuracion[34]['Descripcion']; ?>; color: <?php echo $configuracion[35]['Descripcion']; ?>; font-size: 16px;">
						...
						<h4 class="modal-title"><i class="fa fa-fw fa-edit"></i> Captura de nuevo aviso</h4>
					</div>
		...
		<div id="dataModalA" class="modal fade bs-example-modal-lg">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header" style="background: <?php echo $configuracion[34]['Descripcion']; ?>; color: <?php echo $configuracion[35]['Descripcion']; ?>; font-size: 16px;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title"><i class="fa fa-fw fa-cog"></i> Configurar aviso</h4>
					</div>
		...
		<div id="dataModal_7" class="modal fade bs-example-modal-lg">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header" style="background: <?php echo $configuracion[34]['Descripcion']; ?>; color: <?php echo $configuracion[35]['Descripcion']; ?>; font-size: 16px;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title"><i class="fa fa-fw fa-folder-open-o"></i> Detalle de vistas del aviso</h4>
					</div>
	...
	<script>
		...
		function cargar_ultimo_gasto() {
			...
			$(Capa).load("vistas/admin/reporte_avisos_capturados.php", {}, function(response, status, xhr) {
				if (status == "error") {
		...
		function configurar_aviso(IdAviso,IdCiclo) {
			$.ajax({
				url: "vistas/admin/configurar_aviso.php",
				method: "POST",
				data: {
					IdAviso: IdAviso,
					IdCiclo:IdCiclo
		...
		function ver_avance_reporte(IdAviso) {
			$.ajax({
				url: "vistas/admin/lista_avisos_visto.php",
				method: "POST",
				data: {
					IdAviso: IdAviso
				},
