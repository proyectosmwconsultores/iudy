...
function enviar_formulario_ajax(e){
  ...
  let texto_alerta;
  if(tipo==="save"){
    texto_alerta = "Los datos quedarán gurdados en el sistema.";
  } else if(tipo==="delete"){
    texto_alerta = "Los datos serán eliminado completamente del sistema.";
  } else if(tipo==="update"){
    texto_alerta = "Los datos del sistemas serán actualizado.";
  } else if(tipo==="search"){
