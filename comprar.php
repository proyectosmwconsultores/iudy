<?php $_v = 50; $section = "Comprar paquete"; include("head.php");
...
$prod=$t->get_productoId($IdCompra);
		        ...
		        $(document).ready(function() {
		            ...
		            var sucess_callbak = function(response) {
		              ...
		              // $('#payment-form').submit();
									...
									$.ajax({
		                type:"POST",
		                url:"alumnos/enviar_pago.php",
		                data:{token_id:token_id, deviceSessionId:deviceSessionId,IdUsua:IdUsua,IdCompra:IdCompra},
...
<body class="hold-transition skin-<?php echo $configuracion[15]["Descripcion"]; ?> sidebar-mini fixed">
	<div class="wrapper">
		...
		<div class="content-wrapper">
          ...
          <p class="lead">Detalle de la compra</p>
...
function actualizarPaq(){
  var IdCompra = document.getElementById("IdCompra").value;
  $.ajax({
       url:"reportes/actualizarPaq.php",
       method:"POST",
