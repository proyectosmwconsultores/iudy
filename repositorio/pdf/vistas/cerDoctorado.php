...
<page backtop="10mm" backbottom="10mm" backleft="1mm" backright="10mm">
	...
	<table>
		...
		<img src="../../assets/images/fondoImg.png" style="width: 120px;">
			...
			<br><br><br>
			ACREDITÓ LAS MATERIAS QUE INTEGRAN EL PLAN DE ESTUDIOS DEL: <b style="color: red;"><?php echo $datUs[0]["Educativa"]; ?></b> SEGÚN RVOE ACUERDO NÚMERO: <b style="color: red;"><?php echo $datMen[0]["Rvoe"]; ?></b> VIGENCIA A PARTIR DEL <b style="color: red;"><?php echo $datMen[0]["Vigencia"]; ?></b> OTORGADO POR LA SECRETARÍA DE EDUCACIÓN
			<br><br><br>
