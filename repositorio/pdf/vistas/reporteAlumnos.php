...
<page backtop="45mm" backbottom="20mm" backleft="10mm" backright="10mm">
	...
	/* <table id="encabezado" style="border: none; font-weight:bold; ">
		...
		<tr class="fila">
			...
			<td id="col_7" style="border: none;"><span id="span3"><?php echo $datosEncabezado[0]["Grado"]; ?></span></td>
			<td id="col_3" style="border: none;"><span id="span3">&nbsp;&nbsp;&nbsp;&nbsp; No. Módulo:</span></td>
			<td id="col_3" style="border: none;"><span id="span3"><?php echo $datosEncabezado[0]["NoModulo"]; ?></span></td>
		</tr>
		<tr class="fila">
			<td id="col_5" style="border: none;"><span id="span3">&nbsp;</span></td>
			<td id="col_3" style="border: none;"><span id="span3">&nbsp;&nbsp;&nbsp;&nbsp; Periodo:</span> </td>
			<td id="col_7" style="border: none;"><span id="span3"><?php echo $datosEncabezado[0]["FecIni"].' al '.$datosEncabezado[0]["FecFin"]; ?></span></td>
			<td id="col_3" style="border: none;"><span id="span3">&nbsp;&nbsp;&nbsp;&nbsp; Grupo:</span></td>
			<td id="col_3" style="border: none;"><span id="span3">"<?php echo $datosEncabezado[0]["Grupo"]; ?>"</span></td>
		</tr>
		<tr class="fila">
			<td id="col_5" style="border: none;"><span id="span3">&nbsp;</span></td>
	...
	/* <table style=" padding: 4px;">
		<tr style="background: #DDD3D3; padding: 4px;">
			...
			<td style="width: 520px; font-size: 11px; ">NOMBRE</td>
		</tr>
