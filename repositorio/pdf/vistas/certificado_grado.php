...
<page backtop="50m" backbottom="12mm" backleft="1mm" backright="10mm">
	...
	<div style='width: 100%; height: 1050px;'>
		...
		<p style='font-size: 9px; text-align: left; margin-top: -185px; margin-left: 20px;'>________________________<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FIRMA DEL ALUMNO</p>
		<br><br><br><br><br><br>
		<table style=" margin-left: 20px; margin-top: 180px;">
			<tr>
				<td style="width: 150px; text-align: center; font-size: 12px; border: none;"></td>
				<td style="width: 551px; text-align: justify;  font-size: 10px; border: none; word-spacing: 2.5px; line-height: 1.6;">
	...
	<div style='width: 100%; height: 1050px;'><br><br><br><br><br><br><br><br>
		<table style='margin-left: 20px;'>
			<tr>
				<td style='width: 30px; border: none;'></td>
				<td style='width: 255px; border: none; text-align: center;'>RESPONSABLE DE SERVICIOS<br>ESCOLARES DEL PLANTEL</td>
				<td style='width: 80px; border: none;'></td>
				<td style='width: 255px; border: none; text-align: center;'>DIRECTOR GENERAL</td>
				<td style='width: 30px; border: none;'></td>
			</tr>
			<tr>
				<td colspan='5' style='width: 30px; height: 60px; border: none;'></td>
			</tr>
			<tr>
				<td style='width: 30px; border: none;'></td>
				<td style='width: 255px; text-align: center; border: none;'>______________________________________________</td>
				<td style='width: 80px; border: none;'></td>
				<td style='width: 255px; text-align: center; border: none;'>______________________________________________</td>
				<td style='width: 30px; border: none;'></td>
			</tr>
			<tr>
				<td style='width: 30px; border: none;'></td>
				<td style='width: 255px; text-align: center; border: none;'><?php echo $lstfir[0]['Res_serv_esc_plantel']; ?></td>
				<td style='width: 80px; border: none;'></td>
				<td style='width: 255px; text-align: center; border: none;'><?php echo $lstfir[0]['Rector']; ?></td>
				<td style='width: 30px; border: none;'></td>
			</tr>
			<tr>
				<td colspan='5' style='width: 30px; height: 60px; border: none;'></td>
			...
			<tr>
				<td style='width: 30px; border: none;'></td>
				<td style='width: 255px; border: none; text-align: center;'>JEFA DE DEPARTAMENTO DE<br>SERVICIOS ESCOLARES</td>
				<td style='width: 80px; border: none;'></td>
				<td style='width: 255px; border: none; text-align: center;'>DIRECTOR DE EDUCACIÓN SUPERIOR</td>
				<td style='width: 30px; border: none;'></td>
			</tr>
			<tr>
				<td colspan='5' style='width: 30px; height: 60px; border: none;'></td>
			...
			<tr>
				<td style='width: 30px; border: none;'></td>
				<td style='width: 255px; border: none; text-align: center;'>______________________________________________</td>
				<td style='width: 80px; border: none;'></td>
				<td style='width: 255px; border: none; text-align: center;'>______________________________________________</td>
				<td style='width: 30px; border: none;'></td>
			</tr>
			<tr>
				<td style='width: 30px; border: none;'></td>
				<td style='width: 255px; text-align: center; border: none;'><?php echo $lstfir[0]['Departamento']; ?></td>
				<td style='width: 80px; border: none;'></td>
				<td style='width: 255px; text-align: center; border: none;'><?php echo $lstfir[0]['Educacion_superior']; ?></td>
				<td style='width: 30px; border: none;'></td>
			</tr>
			<tr>
				<td colspan='5' style='width: 30px; height: 130px; border: none;'></td>
			</tr>
		</table>
		<table style='margin-left: 20px;'>
			<tr>
				<td rowspan='2' style='width: 240px; text-align: center; border: none;'>
					<table style='margin-left: 40px; font-size: 9px; border: 0.5px solid black;'>
						<tr>
							<td style='width: 130px; border-bottom: none;'>Registrado en el<br>Departamento de<br> Servicios Escolares<br><br><br>
							</td>
						</tr>
						<tr>
							<td style='width: 130px; line-height: 1.9; text-align: left;'>
							No. _____________________<br>
							LIBRO ___________________<br>
							FOJA ____________________<br>
							FECHA
							</td>
						</tr>
						<tr>
							<td style='width: 130px; line-height: 1.9; '><b>COTEJO</b></td>
						</tr>
						<tr>
							<td style='width: 130px; height: 20px; font-size: 8px;'> <br><?php echo $lstfir[0]['Escolares_sep_cotejo']; ?> </td>
						</tr>
						<tr>
							<td style='width: 130px; line-height: 1.9; '> <b>Jefe de la Ofina</b> </td>
						</tr>
						<tr>
				...
				<td style='width: 350px; text-align: justify; line-height: 1.6; border: none;'>
				CON FUNDAMENTO EN EL ARTÍCULO 29; FRACCIÓN X DE LA LEY
				ORGÁNICA DE LA ADMINISTRACIÓN PÚBLICA DEL ESTADO DE
				CHIAPAS Y 38; FRACCION IX DEL REGLAMENTO INTEIOR DE LA
				SECRETARÍA GENERAL DE GOBIERNO.<br><br>
				Se <b>LEGALIZA,</b> PREVIO <b>cotejo</b> con la existencia de el
				control respectivo, la firma que antecede corresponde al Director de Educación Superior.<br><br>
				</td>
			</tr>
			<tr>
				<td style='width: 50px; border: none;'></td>
				<td style='width: 350px; text-align: center; line-height: 1.6; border: none;'><br>
				<?php echo $lstfir[0]['Educacion_superior']; ?><br>
				________________________________________________________________<br><br>
				Tuxtla Gutiérrez, Chiapas; A: ________________________________________<br><br><br>
				<b>DIRECTORA GENERAL DE ASUNTOS JURÍDICOS DE GOBIERNO</b><br><br><br>
