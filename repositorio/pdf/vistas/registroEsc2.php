...
<page backtop="50mm" backbottom="5mm" backleft="10mm" backright="10mm">
	...
	<table style="margin-top:-1px;">
		<tr style="padding: 4px;">
			...
			<td rowspan="4" style="width:150px; text-align: right;">HOJA: 1 DE 2</td>
		</tr>
		<tr style="padding: 4px;">
	...
	<?php $x= 0; for ($i=0;$i< 1;$i++) { ?>  <!-- Define el cuerpo de la hoja -->
		...
		<tr style="padding: 4px; ">
			...
			<?php  for ($i=25;$i< sizeof($alumnos);$i++) {
			...
			<tr style="padding: 0px; ">
				...
				$idEs = $alumnos[$i]["IdEstatus"];
				 ?> </td>
				<td style="width: 20px; font-size: 9px; border: 1px solid #000;  text-align: center;"> <?php if($idEs== 20){ echo "NP"; } else { if($lstMaterias[0]["CodeModulo"]){ if($lstProm1[0]["Promedio"]){ echo $lstProm1[0]["Promedio"]; } else { echo ""; } } } ?></td>
				<td style="width: 20px; font-size: 9px; border: 1px solid #000;  text-align: center;"> <?php if($idEs== 20){ echo "NP"; } else { if($lstMaterias[1]["CodeModulo"]){ if($lstProm2[0]["Promedio"]){ echo $lstProm2[0]["Promedio"]; } else { echo ""; } } } ?></td>
				<td style="width: 20px; font-size: 9px; border: 1px solid #000;  text-align: center;"> <?php if($idEs== 20){ echo "NP"; } else { if($lstMaterias[2]["CodeModulo"]){ if($lstProm3[0]["Promedio"]){ echo $lstProm3[0]["Promedio"]; } else { echo ""; } } } ?></td>
				<td style="width: 20px; font-size: 9px; border: 1px solid #000;  text-align: center;"> <?php if($idEs== 20){ echo "NP"; } else { if($lstMaterias[3]["CodeModulo"]){ if($lstProm4[0]["Promedio"]){ echo $lstProm4[0]["Promedio"]; } else { echo ""; } } } ?></td>
				<td style="width: 20px; font-size: 9px; border: 1px solid #000;  text-align: center;"> <?php if($idEs== 20){ echo "NP"; } else { if($lstMaterias[4]["CodeModulo"]){ if($lstProm5[0]["Promedio"]){ echo $lstProm5[0]["Promedio"]; } else { echo ""; } } } ?></td>
				<td style="width: 20px; font-size: 9px; border: 1px solid #000;  text-align: center;"> <?php if($idEs== 20){ echo "NP"; } else { if($lstMaterias[5]["CodeModulo"]){ if($lstProm6[0]["Promedio"]){ echo $lstProm6[0]["Promedio"]; } else { echo ""; } } } ?></td>
				...
				<td style="width: 30px; font-size: 9px; border: 1px solid #000; text-align: center;"> <?php if($alumnos[$i]["IdEstatus"] == 8){ echo "P"; } else { echo "BD"; } ?> </td>
			</tr><?php }  $num = (50 - $i); ?>
			<input type="hidden" name="Numero" id="Numero" value="<?php echo $num; ?>">

			<?php if( $i > 25) { $maxi = 50; } else { $maxi = 50; } //$resta = $i - 23;
			//if( $resta < 0){ ?>
