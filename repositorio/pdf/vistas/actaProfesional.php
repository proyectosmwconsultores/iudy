...
<page backtop="30m" backbottom="12mm" backleft="1mm" backright="10mm">
	...
	<table style="margin-top: -140px;">
		...
		<tr>
			<td style="width: 765px; text-align: center; font-size: 14px; border: none;">
				...
				<b style="font-size: 12px;">DIRECCIÓN DE EDUCACIÓN SUPERIOR</b><br>
				<b style="font-size: 11px;">DEPARTAMENTO DE SERVICIOS ESCOLARES</b><br>
				<b style="font-size: 11px;">UNIVERSIDAD DEL SURESTE</b><br>
				<b style="font-size: 8px;">RVOE: ACUERDO NÚMERO <?php echo $datMen[0]['Rvoe']; ?>  VIGENTE: A PARTIR DE <?php echo $datMen[0]['Vigencia']; ?></b>
			</td>
		</tr>
		<tr>
			<td style="width: 400px; height: 50px; text-align: center; font-size: 10px; border: none; padding-right: 17px;"><b>RÉGIMEN: PARTICULAR </b> FOLIO No: <b style="color: red; font-size: 10;"><u>&nbsp;&nbsp;&nbsp; <?php echo $acta[0]['Folio']; ?> &nbsp;&nbsp;&nbsp;</u></b></td>
		</tr>
	</table>
	<table>
		<tr>
		...
		<img src="../../assets/images/fondoImg.png" style="width: 100px; margin-left: 30px; margin-top: -15px;">
			...
			<td style="width: 565px; text-align: justify; font-size: 13px; border: none; ">
			    <table>
			        <tr>
			            <td colspan='5' style="width: 360px; border: none; height: 10px;">ACTA &nbsp;&nbsp;&nbsp; DE &nbsp;&nbsp; EXAMEN &nbsp;&nbsp; PROFESIONAL &nbsp;&nbsp; No.<?php echo $acta[0]['No']; ?> &nbsp;&nbsp; AUTORIZACIÓN No.</td>
	...
	<table style="margin-left: 35px;">
	    ...
	    <tr><td colspan='7' style="width: 400px; border: none;"></td></tr><tr><td colspan='7' style="width: 400px; border: none;"></td></tr>
	    <tr>
	        <td colspan='2' style="width: 80px; height: 10px; border: none;">VOCAL:</td>
	        <td colspan='5' style="border: 0.6px solid black; width: 300px; border-right: none;"><b><?php echo $acta[0]['Vocal']; ?></b></td>
	    </tr>
	    <tr><td colspan='7' style="width: 400px; border: none;"></td></tr><tr><td colspan='7' style="width: 400px; border: none;"></td></tr>
	    <tr>
	        <td colspan='5' style="width: 350px; height: 10px; border: none;">PARA &nbsp; REALIZAR &nbsp; EL &nbsp; EXAMEN &nbsp; PROFESIONAL &nbsp; AL (A) C. PASANTE:</td>
	        <td colspan='2' style="width: 200px; border:none;"></td>
	    </tr>
	    <tr><td colspan='7' style="width: 400px; border: none;"></td></tr><tr><td colspan='7' style="width: 400px; border: none;"></td></tr>
	    <tr>
	    ...
	    <tr><td colspan='7' style="width: 400px; border: none;"></td></tr><tr><td colspan='7' style="width: 400px; border: none;"></td></tr>
	    <tr>
	        <td colspan='3' style="width: 170px; height: 10px; border: none;"><br>PARA OBTENER EL TÍTULO DE:</td>
	    ...
	    <tr><td colspan='7' style="width: 400px; border: none;"></td></tr><tr><td colspan='7' style="width: 400px; border: none;"></td></tr>
	    <tr>
	        <td colspan='7' style="width: 500px; text-align: center; height: 10px; border: none; font-size:9px;"> <br><br>¡SI PROTESTO!<br><br></td>
	    </tr>
	    <tr><td colspan='7' style="width: 400px; border: none;"></td></tr><tr><td colspan='7' style="width: 400px; border: none;"></td></tr>
	    <tr>
	        <td colspan='7' style="width: 500px; text-align: center; border: none; font-size:9px;"><br>_______________________________________________
	        <br><br><b><?php echo $datUs[0]['Nombre'].' '.$datUs[0]['APaterno'].' '.$datUs[0]['AMaterno']; ?></b></td>
	    </tr>
	    <tr><td colspan='7' style="width: 400px; border: none;"></td></tr><tr><td colspan='7' style="width: 400px; border: none;"></td></tr>
	    <tr>
	        <td colspan='7' style="width: 500px; text-align: center; border: none; font-size:10px;"><br><br> SI &nbsp; ASÍ &nbsp;LO &nbsp; HICIERE, &nbsp; QUE &nbsp; LA &nbsp; SOCIEDAD &nbsp; Y &nbsp; LA &nbsp; NACIÓN &nbsp; SE &nbsp; LO &nbsp; PREMIEN &nbsp; Y &nbsp; SI &nbsp; NO, &nbsp; SE &nbsp; LO &nbsp; DEMANDEN.</td>
	    </tr>
	...
	<table style="margin-left: 35px;">
	    <tr style=''>
	        <td colspan='5' style="width: 400px; text-align: center; font-size: 10px; border: none; ">
	        ...
	        <td colspan='5' style="width: 400px; height: 30px; text-align: center; font-size: 10px; border: none; ">
					JURADO DEL EXAMEN
					</td>
	    </tr>
			<tr style='font-weight: bold;'>
	        <td colspan='2' style="width: 300px; text-align: center; height: 30px; border: none; font-size: 10px;">NOMBRE:</td>
	        <td style="width: 12px; text-align: center; border: none; "></td>
					<td colspan='2' style="width: 300px; text-align: center; border: none; font-size: 10px;">FIRMA:</td>
	    </tr>
			<tr>
	        <td colspan='2' style="width: 300px; text-align: center; border-left: none; border-right: none; font-size: 10px;"><b><?php echo $acta[0]['Presidente']; ?></b></td>
	        <td style="width: 12px; text-align: center; border: none;  "></td>
	        <td colspan='2' style="width: 300px; text-align: center; border-right: none; "></td>
	    </tr>
			<tr>
	        <td colspan='2' style="width: 300px; text-align: center; border-left: none; border-right: none; border-bottom: none; font-size: 9px;">PRESIDENTE</td>
	        <td style="width: 12px; text-align: center; border: none; "></td>
					<td style="width: 158px; text-align: right; border-right: none; border-bottom: none; font-size: 9px;">CEDULA PROF. No</td>
	        <td style="width: 158px; text-align: center; border-right: none; font-size: 9px;"><b><?php echo $acta[0]['Cedula1']; ?></b></td>
	    </tr>
			<tr>
			...
			<tr>
	        <td colspan='2' style="width: 300px; text-align: center; border-left: none; border-right: none; font-size: 10px; "><b><?php echo $acta[0]['Secretario']; ?></b></td>
	        <td style="width: 12px; text-align: center; border: none;  "></td>
	        <td colspan='2' style="width: 300px; text-align: center; border-right: none;"></td>
	    </tr>
			<tr>
	        <td colspan='2' style="width: 300px; text-align: center; border-left: none; border-right: none; border-bottom: none; font-size: 9px;">SECRETARIO</td>
	        <td style="width: 12px; text-align: center; border: none; "></td>
					<td style="width: 158px; text-align: right; border-right: none; border-bottom: none; font-size: 9px;">CEDULA PROF. No</td>
	        <td style="width: 158px; text-align: center; border-right: none; font-size: 9px;"><b><?php echo $acta[0]['Cedula2']; ?></b></td>
	    </tr>
			<tr>
	        <td colspan='5' style="width: 400px; height: 50px; text-align: center; font-size: 12px; border-left: none; border-right: none; border-bottom: none;"></td>
	    </tr>
			<tr>
	        <td colspan='2' style="width: 300px; text-align: center; border-left: none; border-right: none; font-size: 10px;"><b><?php echo $acta[0]['Vocal']; ?></b></td>
	        <td style="width: 12px; text-align: center; border: none; "></td>
	        <td colspan='2' style="width: 300px; text-align: center; border-right: none;"></td>
	    </tr>
			<tr>
	        <td colspan='2' style="width: 300px; text-align: center; border-left: none; border-right: none; border-bottom: none; font-size: 9px;">VOCAL</td>
	        <td style="width: 12px; text-align: center; border: none; "></td>
					<td style="width: 158px; text-align: right; border-right: none; border-bottom: none; font-size: 9px;">CEDULA PROF. No</td>
	        <td style="width: 158px; text-align: center; border-right: none; font-size: 9px;"><b><?php echo $acta[0]['Cedula3']; ?></b></td>
	    </tr>
			<tr>
			...
			<tr>
	        <td colspan='5' style="border:none; font-weight: bold; width: 400px; height: 60px; text-align: center; font-size: 10px; ">RECTOR<br><br><br>_______________________________________________</td>
	    </tr>
			<tr>
	        <td colspan='5' style="border:none; width: 400px; text-align: center; font-size: 11px; "><b><?php echo $lstfir[0]['Rector']; ?></b></td>
	    </tr>
			<tr>
	...
	<table style="margin-left: 35px; ">
	        ...
	        <td rowspan='6' style="width: 250px; text-align: center; border: none; ">
						<table style='font-size: 9px; margin-left: 20px;'>
							<tr><td style='width: 150px; padding: 5px; background: #c0c0c0;'>REGISTRO EN EL DEPARTAMENTO DE SERVICIOS<br>ESCOLARES</td></tr>
							...
							<tr><td style='width: 150px; padding: 5px; text-align: center; background: #c0c0c0;'>COTEJÓ</td></tr>
							<tr><td style='width: 150px; padding: 5px; text-align: left;'><br><br></td></tr>
							<tr><td style='width: 150px; padding: 5px; text-align: center; background: #c0c0c0;'>JEFE DE OFICINA</td></tr>
	        ...
	        <td colspan='2' style="width: 250px; text-align: justify; font-size: 10px; border: none;">
					POR ACUERDO DEL SECRETARIO GENERAL DE GOBIERNO Y CON FUNDAMENTO EN EL ARTÍCULO 28 FRACCIÓN X, DE LA LEY ORGÁNICA DE LA ADMINISTRACIÓN PÚBLICA DEL ESTADO DE CHIAPAS.<br>
					<br>
					SE <b>LEGALIZA,</b> PREVIO COTEJO CON LA QUE EXISTE EN EL CONTROL RESPECTIVO, LA FIRMA QUE ANTECEDE, CORRESPONDE AL DIRECTOR DE EDUCACIÓN SUPERIOR
			...
			<tr>
	        <td colspan='2' style="width: 300px; text-align: center; font-size: 9px; font-weight: bold; border-left: none; border-right: none; ">
					<br><br>SUBSECRETARIO DE ASUNTOS JURÍDICOS<br><br>
					</td>
	    </tr>
			<tr>
			...
			<tr>
	        <td colspan='2' style="width: 300px; border:none;"><br><br></td>
	    </tr>
			<tr>
	        <td colspan='4' style="width: 250px; text-align: center; border:none; font-size: 10px;"><br><br>ESTE DOCUMENTO NO ES VÁLIDO SI PRESENTA RASPADURAS O ENMENDADURAS</td>
	    </tr>
			<tr>
