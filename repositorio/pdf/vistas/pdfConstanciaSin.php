...
<page backtop="70mm" backbottom="20mm" backleft="10mm" backright="10mm">
  ...
  <div style="width: 727px; height: 80px; margin-left: -12px; text-align: justify; font-size: 13.5px;">
	...
	<div style="width: 727px; height: 100px; margin-left: -12px; text-align: justify; font-size: 15px;">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		Que el (a) alumno (a) <b>C. <?php echo $datos[0]["APaterno"].' '.$datos[0]["AMaterno"].' '.$datos[0]["Nombre"]; ?></b> con número de control <b><?php echo $datos[0]["Matricula"]; ?>,</b>
		actualmente se encuentra inscrito en el <b><?php echo obtenerLetraN($datos[0]["SemCua"]); ?></b> Cuatrimestre de la <b><?php echo $datos[0]["NomEducativa"]; ?>,</b> en el periodo escolar <?php echo obtenerPeriodo($datosCiclo[0]["FInicio"]); ?> al <?php echo obtenerPeriodo($datosCiclo[0]["FFinal"]); ?> del año <?php echo substr($datosCiclo[0]["FFinal"],0,4); ?>.
	</div>
	...
	<div style="width: 727px; height: 110px; margin-left: -12px; text-align: justify; font-size: 15px;">
		...
		extiende la presente en la ciudad de <?php echo $config[19]["Descripcion"]; ?>,a los <?php echo numeroMiniscula(substr($consulta[0]["Fecha"],8,2), false, false); ?> días del mes de <?php echo obtenerMesPrincipal($consulta[0]["Fecha"]); ?>
		del año <?php echo numeroMiniscula(substr($consulta[0]["Fecha"],0,4), false, false); ?>.
