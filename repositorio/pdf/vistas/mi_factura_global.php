<?php
	...
	$deta = $t->get_detalle_global_id($_Folio);
...
?>
	...
	<page backtop="50mm" backbottom="20mm" backleft="10mm" backright="10mm">
		<page_header>
			...
			<table style="margin-left: 38px; margin-top: 30px;">
				<tr>
		...
		for ($c = 0; $c < 1; $c++) { ?>
			...
			<table style="font-size: 11px;">
				...
				<tr>
					...
					<td style="width: 74px; background: #d9d9d9; color: #0082b7;"><b>Fecha emisión:</b></td>
			...
			<table style="font-size: 11px;">
				<tr>
					...
					<td style="width: 300px; ">PUBLICO EN GENERAL</td>
				...
				<tr>
					...
					<td style="width: 300px; ">XAXX010101000</td>
				...
				<tr>
					...
					<td colspan="3" style="width: 500px; "> <?php echo "Carretera Federal Villahermosa-Teapa No. KM. 1, Plutarco Elias Calles, 86280, Centro Tabasco, México."; ?></td>
				</tr>
			</table>
			<br>
			<table style="font-size: 11px;">
				<tr style="text-align: center;">
					...
					<td style="width: 40px; background: #d9d9d9; color: #0082b7;"><b>Clave Unidad<br>SAT</b></td>
					<td style="width: 50px; background: #d9d9d9; color: #0082b7;"><b>Clave <br>producto / servicio</b></td>
					<td style="width: 290px; background: #d9d9d9; color: #0082b7;"><b>Concepto /<br>descripción</b></td>
					...
					<tr style="text-align: center; font-size: 10px;">
						<td style="width: 30px; "><?php echo $pag[0]['Cantidad']; ?>.00</td>
						<td style="width: 40px; "><?php echo $pag[0]['ClaveUnidad'] . ' - ' . $pag[0]['Unidad']; ?></td>
						<td style="width: 50px; "><?php echo $pag[0]['ClaveProdServ']; ?> </td>
						<td style="width: 290px; text-align: justify; font-size: 9px;">ENSEÑANAS VARIAS: <br>COBROS:<br><br>
						    <?php for ($i = 0; $i < 35; $i++) { ?>
						    <?php echo $pag[$i]['Descripcion']; ?> [$<?php echo $pag[$i]['Importe']; ?>], 
						    <?php } ?> [...]
						    </td>
						<td style="width: 65px; "><?php echo number_format($dat_fac[0]['SubTotal'], 2, '.', ','); ?></td>
						<td style="width: 65px; "><?php echo number_format($dat_fac[0]['Descuento'], 2, '.', ','); ?></td>
						<td style="width: 45px; ">0.00</td>
						<td style="width: 57px; text-align: right; "><?php echo number_format($dat_fac[0]['SubTotal'], 2, '.', ','); ?></td>
					</tr>
			...
			<table style="font-size: 11px; margin-top: 0px;">
				<tr>
			...
			<img src="../../assets/docs/factura/<?php echo $dat_fac[0]['Anio']; ?>/<?php echo $dat_fac[0]['Mes']; ?>/<?php echo $qrCode; ?>" style="width: 90px; margin-top: -80px; margin-left: -10px; ">
			<br><br><br><br><br><br>
			<table style="font-size: 11px;">
				<tr>
