...
<page backtop="67mm" backbottom="20mm" backleft="10mm" backright="10mm">
	...
	<table style='margin-left: 4px; font-size: 10px;'>
		<tr>
			...
			<td style="width: 278px;"><b>NOMBRE DEL ALUMNO</b></td>
			<td colspan="4" style="width: 40px; text-align: center;"><b>ASISTENCIA</b></td>
			<td colspan="2" style="width: 100px; text-align: center;"><b>CALIFICACIÓN</b></td>
		</tr>
		...
		<tr>
			...
			<td style="width: 278px;"><?php echo $lstUs[$y]['APaterno'].' '.$lstUs[$y]['AMaterno'].' '.$lstUs[$y]['Nombre']; ?></td>
			<td style="width: 10px; text-align: center;"><?php echo $ses1[0]['Imprimir']; ?></td>
			<td style="width: 10px; text-align: center;"><?php echo $ses2[0]['Imprimir']; ?></td>
			<td style="width: 10px; text-align: center;"><?php echo $ses3[0]['Imprimir']; ?></td>
			<td style="width: 10px; text-align: center;"><?php echo $ses4[0]['Imprimir']; ?></td>
			<td style="width: 27px; text-align: center;"><?php echo $lstUs[$y]['Promedio']; ?></td>
			<td style="width: 83px; text-align: center;"><?php echo obtNumLetr($lstUs[$y]['Promedio']); ?></td>
		</tr><?php }
			if($c <= 37) {  $num = (37 - $c); }
			for ($v=1;$v<=$num;$v++) { ?>
		<tr>
