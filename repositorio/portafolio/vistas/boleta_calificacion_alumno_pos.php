...
<page backtop="90mm" backbottom="20mm" backleft="10mm" backright="10mm">
	...
	<table style='margin-left: 4px; font-size: 10px;'>
		<tr style="background: #c1c1c1;">
			...
			<td style="width: 50px; text-align: center;"><b>1°<br>Parcial</b></td>
			<td style="width: 50px; text-align: center;"><b>2°<br>Parcial</b></td>
			<td style="width: 50px; text-align: center;"><b>Calificación final</b></td>
			<td style="width: 36px; text-align: center;"><b>Ext.</b></td>
			<td style="width: 36px; text-align: center;"><b>Rec.</b></td>
		</tr>
		<?php $c = 0; $sum = 0; for ($y=0;$y< sizeof($lstMat);$y++) {
			...
			<tr>
				...
				<?php if($lstMat[$y]['Tipo'] == '1'){ $c = ($c + 1);
					$sum = ($sum + $prom1); ?>
				<td style="width: 50px; text-align: center;"><?php if(isset($cal[0]['P1'])){ echo $cal[0]['P1']; } ?></td>
				<td style="width: 50px; text-align: center;"><?php if(isset($cal[0]['P2'])){ echo $cal[0]['P2']; } ?></td>
				...
				<td style="width: 36px; text-align: center;"><?php if(isset($cal[0]['E1'])){ echo $cal[0]['E1']; } ?></td>
				<td style="width: 36px; text-align: center;"><?php if(isset($cal[0]['E2'])){ echo $cal[0]['E2']; } ?></td>
				<?php } else { ?>
