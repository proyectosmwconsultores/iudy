...
if($_SESSION['Permisos']){
	...
	$lstGrp=$t->get_prom_grupo_id($idCiclo,$idGrupo);
	$encabz=$t->get_datos_impresion($lstGrp[0]['IdAsignacion']);
...
<page backtop="51mm" backbottom="20mm" backleft="10mm" backright="10mm">
    ...
    <table style='margin-top: -115px;'>
        <tr>
            <td style='width: 515px; text-align: center; border:none;'>
                ...
                <b>PROMEDIO GENERAL DEL GRUPO EN EL CICLO ESCOLAR</b>
                </p>
            </td>
	...
	<table style='margin-left: 38px; margin-top: 10px;'>
		...
		<tr>
			...
			<td style="width: 90px; text-align: right;"><b>CICLO ESCOLAR:</b></td>
	...
	<table>
			<tr>
				<td style="width: 60px;"><b>SIGLA</b></td>
				<td style="width: 443px;"><b>NOMBRE DE LA MATERIA</b></td>
				<td style="width: 145px; text-align: center;"><b>PROMEDIO</b></td>
			</tr>
			<?php $prom = 0;  for ($y=0;$y< sizeof($lstGrp);$y++) { $x = $x + 1; $prom = ($prom + $lstGrp[$y]['Promedio']); ?>
				<tr>
					<td style="width: 60px;"><?php echo $lstGrp[$y]['CodeModulo']; ?></td>
					<td style="width: 443px;"><?php echo $lstGrp[$y]['NombreMod']; ?></td>
					<td style="width: 145px; text-align: center;"><?php echo $lstGrp[$y]['Promedio']; ?></td>
				</tr><?php } $pro_grupo = ($prom / $x); ?>
				<tr>
					<td colspan="2" style="text-align: right;"><b>PROMEDIO GENERAL DEL GRUPO:</b></td>
					<td style="text-align: center;"><b><?php echo number_format($pro_grupo, 1, '.', ','); ?></b></td>
				</tr>
	</table>
