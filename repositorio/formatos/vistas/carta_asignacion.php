...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm">
	...
	<table style="margin-left: 0px; margin-top: 50px; font-size: 13px; border-collapse: collapse;">
		<tr>
			<td style="text-align: center; width: 640px; padding: 4px; font-size: 16px;"><b>CARTA DE ASIGNACIÓN DE PRÁCTICAS PROFESIONALES</b></td>
		</tr>
		<tr>
	...
	<table style="margin-left: 0px; font-size: 13px; border-collapse: collapse;">
		<tr>
			<td style=" width: 100px; padding: 4px; font-size: 11px;"><b>FECHA DE INICIO:</b></td>
			<td style="text-align: left; border-bottom: 0.5 px solid black; width: 150px; padding: 4px; font-size: 11px;"><?php echo obtFechConst($fecha); ?></td>
			<td style="text-align: right; width: 249px; padding: 4px; font-size: 11px;"><b>TOTAL DE HORAS:</b></td>
			<td style="text-align: center; border-bottom: 0.5 px solid black; width: 100px; padding: 4px; font-size: 11px;">720 HORAS</td>
		</tr>
	</table>
	<table style="margin-left: 0px; margin-top: 30px; font-size: 10px; border-collapse: collapse;">
		<tr>
			<td style="text-align: right; width: 428px; padding: 4px; font-size: 12px;"><b>FECHA DE ELABORACIÓN:</b></td>
			<td style="text-align: center; border-bottom: 0.5px solid black; width: 200px; padding: 4px; font-size: 12px;"><?php echo obtFechConst($prac[0]['Fecha_impresion']); ?></td>
		</tr>
	</table>
	<table style="margin-left: 0px; margin-top: 50px; font-size: 10px; border-collapse: collapse;">
		<tr>
			<td style="text-align: center; border-bottom: 0.5px solid black; width: 265px; padding: 4px; font-size: 10px;"><b><?php echo $firma[0]['Nombre'].' '.$firma[0]['APaterno'].' '.$firma[0]['AMaterno']; ?></b></td>
		...
		<tr>
			<td style="text-align: center; width: 265px; padding: 4px; font-size: 10px;">RESPONSABLE DE LA  INSTITUCIÓN EDUCATIVA<br>NOMBRE Y FIRMA</td>
			<td style="text-align: center; width: 80px; padding: 4px; font-size: 12px;"></td>
			<td style="text-align: center; width: 265px; padding: 4px; font-size: 10px;">RESPONSABLE DEL PROGRAMA<br>NOMBRE, FIRMA Y SELLO</td>
		</tr>
	</table>
	<table style="margin-left: 0px; margin-top: 50px; font-size: 10px; border-collapse: collapse;">
		<tr>
		<td style="text-align: center; width: 170px; padding: 4px; font-size: 10px;"></td>
		...
		<tr>
		<td style="text-align: center; width: 170px; padding: 4px; font-size: 10px;"></td>
			<td style="text-align: center; width: 265px; padding: 4px; font-size: 10px;">NOMBRE Y FIRMA  DEL PRESTADOR</td>
			<td style="text-align: center; width: 170px; padding: 4px; font-size: 10px;"></td>
		</tr>
	</table>
