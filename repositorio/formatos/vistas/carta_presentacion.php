...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm">
	...
	<table style="margin-left: 0px; margin-top: 50px; font-size: 13px; border-collapse: collapse;">
		...
		<tr>
			<td style="text-align: right; width: 640px; padding: 5px;"><b>Asunto:</b> Carta de Presentación de Prácticas Profesionales </td>
		</tr>
		<tr>
			<td style="text-align: right; width: 640px; padding: 5px;"><b>FOLIO: IUDY/<?php echo $prac[0]['Anio']; ?>/<?php echo $prac[0]['Folio']; ?></b></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<b style="font-size: 12px;"><?php echo $prac[0]['Nombre']; ?> <?php echo $prac[0]['APaterno']; ?> <?php echo $prac[0]['AMaterno']; ?><br></b>
			<b>Matricula: <?php echo $prac[0]['Usuario']; ?></b><br><br><br>
			</td>
		</tr>
		<tr>
			<td style="text-align: justify; width: 640px; padding: 5px;">
			Quien se encuentra interesado(a) en realizar sus <b>“Prácticas Profesionales”</b> con el fin de ampliar sus conocimientos y comenzar su desarrollo profesional. El (La) estudiante deberá cubrir 720 horas, en un periodo de 6 meses, comprendido del <?php echo obtFechConst($ini); ?> al <?php echo obtFechConst($fin); ?>, debiendo presentar bimestralmente un reporte de actividades.<br><br><br>
			</td>
		</tr>
		<tr>
			<td style="text-align: justify; width: 640px; padding: 5px;">
		...
		<tr>
			<td style="text-align: center; width: 640px; padding: 5px;">
				<?php if($firma[0]['id_paquete']){ ?>
					<img src="../../assets/firma/<?php echo $firma[0]['id_paquete']; ?>" style="width:200px; margin-top: -150px;" ;>
				<?php }?>
