...
<page backtop="20mm" backbottom="10mm" backleft="10mm" backright="10mm">
	...
	<table style="text-align: justify;">
	    <tr>
	        ...
	        <td style='width: 480px; height: 30px;  font-size: 16px; color: black; font-family: Arial; font-weight: bold; text-align: center;'>ACTA DE TITULACIÓN DE LICENCIATURA</td>
	    </tr>
	    <tr>
	        <td style='width: 200px;'></td>
	    ...
	    <tr>
	        ...
	        <td style='width: 480px; height: 100px; line-height: 20px; font-size: 16px; color: black; font-family: Arial; font-weight: bold; text-align: center;'>
	            <?php $sexo = substr($titulo[0]['P_curp'], 10, 1); if($sexo == "H"){ echo "LICENCIADO";} else { echo "LICENCIADA"; } ?> <?php echo $titulo[0]['_imprimir']; ?>
	        </td>
	    </tr>
	    <tr>
	        <td style='width: 200px;'></td>
