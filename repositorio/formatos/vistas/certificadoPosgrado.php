...
<page backtop="10mm" backbottom="2mm" backleft="10mm" backright="10mm">
	...
	<div style="width: 710px; font-size: 12px; height: 15px; padding: 4px; text-align: center; ">
		...
		<p style="font-size: 10px; text-align: right;"><b>CERTIFICADO No: <?php echo $cert[0]['Folio']; ?></b></p>
	</div>
	<div style="width: 710px; font-size: 12px; height: 15px; padding: 4px; text-align: center; ">
	...
	<div style=" width: 700px; font-family: arial, sans-serif;">
		<table style="font-size: 10px;">
			<tr>
				<td style="width: 110px; text-align: center;"><b style="margin-top: 300px;">________________<br>FIRMA DEL<br>ALUMNO</b></td>
		...
		<div style="width: 680px; font-size: 12px; height: 15px; padding: 4px; text-align: justify;  ">
			<b>EL PRESENTE DOCUMENTO AMPARA <?php echo $rvoe[0]['Materias']; ?> ASIGNATURAS, QUE INTEGRAN EN PLAN DE ESTUDIOS RESPECTIVO,
				CORRESPONDIENTE A <?php echo $rvoe[0]['Creditos']; ?> CRÉDITOS. LA ESCALA DE CALIFICACIONES ES DE 5 A 10 Y LA MÍNIMA APROBATORIA ES DE 6.</b><br><br><br>
		...
		<table style="border-collapse: collapse; font-size: 10px; margin-left: 20px;">
			<tr>
				<td style="border-bottom: 0.5px solid black; padding: 4px; width:250px; text-align: center;"></td>
				<td style="padding: 4px; width:88px;"></td>
				<td style="border-bottom: 0.5px solid black; padding: 4px; width:250px; text-align: center;"><b>SE AUTENTIFICA CON FUNDAMENTO EN EL<br>ARTÍCULO 14 DE LA LEY GENERAL DE<br> EDUCACIÓN SUPERIOR</b><br><br><br><br></td>
			</tr>
			<tr>
