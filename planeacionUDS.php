...
if($_SESSION['IdUsua']){ $addIngresos=$t->add_ingresos($_SESSION['IdUsua'],'Está en el modulo de planeaciones UDS'); }
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Planeaciones - Universidad del Sureste</h1>
      <ol class="breadcrumb">
        <li><a href="inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">Planeaciones UDS</li>
      </ol>
    </section>
    <section class="content">
      <form name="frm" id="frm" action="planeacionUDS.php" method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-widget widget-user-2">
            <div class="widget-user-header" style=" background: #04152b; color: white;">
              ...
              <h3 class="widget-user-username">PLANEACIONES UDS</h3>
              ...
              <ul class="mailbox-attachments clearfix">
                <?php for ($i=0;$i< sizeof($datOfe);$i++) {
                  ...
                  if (file_exists($imgh)) { $img = $datOfe[$i]["Clave"].'.png'; } else {  $img = 'MODULO.png'; }
                   ?>
                <li onClick="window.open('planeacion.php?idLibro=<?php echo time().$datOfe[$i]["IdEducativa"]; ?>','_self')" href="javascript:void(0);" style="cursor: pointer;">
