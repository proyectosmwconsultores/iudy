...
<body class="hold-transition skin-<?php echo $configuracion[15]["Descripcion"]; ?> sidebar-mini fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
              ...
              <div class="paytabs-card">
                ...
                <div class="paytabs-header">
                  ...
                  <div class="paytabs-title-area">
                    ...
                    <div>
                      <div class="paytabs-title">Mi servicio social </div>
                      <div class="paytabs-sub">Espacio para poder visualizar la disponibilidad del servicio social </div>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="nav-tabs-custom">
                        <div class="tab-content">
                          <div class="tab-pane active" id="activity">
                            <div class="bg-active color-palette" style="padding: 5px; background: #1d3462; color: white;"><span><i class="fa fa-fw fa-odnoklassniki"></i> Servicio social</span></div>
      ...
      <div id="data_instructivo" class="modal fade bs-example-modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header" style="background: <?php echo $configuracion[34]['Descripcion']; ?>; color: <?php echo $configuracion[35]['Descripcion']; ?>; font-size: 16px;">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title"><i class="fa fa-fw fa-flag"></i> Instructivo "Servicio social"</h4>
            </div>
            <div class="modal-body" id="employee_instructivo">
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    function inscripcion_servicio(IdUsua, IdAviso, IdDetalle) {
      var Tipo = 1;
      $.ajax({
    ...
    function mostrar_seguimiento(IdUsua) {
      ...
      $(Capa).load("vistas/servicio/alumno_espacio.php", {
        IdUsua: IdUsua
    ...
    function save_docs_practica(IdUsua, IdServicio) {
      ...
      swal({
        ...
        function(isConfirm) {
          if (isConfirm) {
            ...
            $.ajax({
                url: 'vistas/upload/subir_docs_servicio.php',
                type: 'post',
                data: formData,
                contentType: false,
                processData: false,
    ...
    function abrir_archivo_pdf() {
      $.ajax({
        url: "vistas/servicio/ver_instructivo.php",
        method: "POST",
        data: {},
        success: function(data) {
          $('#employee_instructivo').html(data);
          $('#data_instructivo').modal('show');
        }
      });
    }
  </script>
