<?php $section = "Reporte de usuarios";
include("head.php");
if ($_SESSION['IdUsua']) {
	$addIngresos = $t->add_ingresos($_SESSION['IdUsua'], 'Está visualizando el reporte de usuarios activos');
}
...
<body class="hold-transition skin-<?php echo $configuracion[15]["Descripcion"]; ?> sidebar-mini fixed">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					Reporte de usuarios activos por rvoe
				</h1>
				<ol class="breadcrumb">
			...
			<section class="content">
				<form name="frm" id="frm" action="repUsuarios.php" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<select class="form-control select2" name="txtCampus" id="txtCampus">
												...
												<?php } ?>
												<option value="10">TODOS LOS CAMPUS</option>
											</select>
	...
	<script>
		function cargar_lista_bajas() {
			...
			$(Capa).load("vistas/admin/lista_usuario_activos_rvoe.php", {
				IdCampus: IdCampus
